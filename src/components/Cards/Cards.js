  ...
  return (
    <div className='container d-flex justify-content-center'>
        <div className="row">
            ...
            <div className="col-md-4">
                <Card img={"/images/nature3.jpg"} title="How?" data="The radar is designed with the idea of providing useful information to the senior leaders of the organizations. They can: " data2="• Self-explore numerous innovative sustaunable solutions." data3="• Customizae generic radar as per personal and organizational priorities." data4="• Use the assets as a tool for running workshops with stakeholders." />
            </div>
        </div>
    </div>
  )
