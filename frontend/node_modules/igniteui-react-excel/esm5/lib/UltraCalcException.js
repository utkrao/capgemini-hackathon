 ...
 * @hidden
 */
var UltraCalcException = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(UltraCalcException, _super);
    function UltraCalcException(a) {
        var _rest = [];
    ...
    return UltraCalcException;
}(BaseError));
export { UltraCalcException };
