 ...
 * @hidden
 */
var CT_BuiltInUnit = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CT_BuiltInUnit, _super);
    function CT_BuiltInUnit() {
        var _this = _super.call(this) || this;
        _this.c = 0;
        return _this;
    }
    Object.defineProperty(CT_BuiltInUnit.prototype, "b", {
        get: function () {
            return this.c;
        },
        set: function (a) {
    ...
    CT_BuiltInUnit.f = function (a, b, c) {
        a.ad.p(b, "c");
        var d = null;
        var e = null;
        e = "val";
        d = XmlNamespaceDefinitionBase.p(ST_BuiltInUnit_$type, c);
        a.ad.h(e, d);
        ;
    };
    CT_BuiltInUnit.prototype.toString = function () {
    ...
    return CT_BuiltInUnit;
}(Base));
export { CT_BuiltInUnit };
