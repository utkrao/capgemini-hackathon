...
import { CT_ConditionalFormat } from "./CT_ConditionalFormat";
import { CultureInfo } from "igniteui-react-core";
import { parseUInt32_1 } from "igniteui-react-core";
/**
 * @hidden
 */
var CT_ConditionalFormats = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CT_ConditionalFormats, _super);
    function CT_ConditionalFormats() {
        var _this = _super.call(this) || this;
        _this.a = null;
        _this.c = 0;
        _this.a = new List$1(CT_ConditionalFormat.$, 0);
        return _this;
    }
    CT_ConditionalFormats.e = function (a, b) {
        var e_1, _a;
        b = 0;
        try {
    ...
    CT_ConditionalFormats.f = function (a, b, c) {
        a.ad.p(b, null);
        var d = null;
        var e = null;
        e = "count";
    ...
    CT_ConditionalFormats.prototype.setProperty = function (a, b) {
        switch (a) {
            case 333:
    ...
    CT_ConditionalFormats.prototype.toString = function () {
