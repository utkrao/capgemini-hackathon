 ...
 * @hidden
 */
var CalendarUtilities = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CalendarUtilities, _super);
    function CalendarUtilities() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CalendarUtilities.b = function (a) {
        return a.eras.length;
    };
    CalendarUtilities.a = function (a) {
        if (a == null) {
            return 0;
        }
    ...
    return CalendarUtilities;
}(Base));
export { CalendarUtilities };
