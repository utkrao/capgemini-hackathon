 ...
 * @hidden
 */
var ChartStyleElements = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ChartStyleElements, _super);
    function ChartStyleElements() {
    ...
    return ChartStyleElements;
}(Base));
export { ChartStyleElements };
