 ...
 * @hidden
 */
var CharUnicodeInfo = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CharUnicodeInfo, _super);
    function CharUnicodeInfo() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CharUnicodeInfo.staticInit = function () {
        var a = "\\p{Lo}";
        CharUnicodeInfo.k = unicode_hack(a);
    };
    CharUnicodeInfo.g = function (a) {
        throw new NotImplementedException(0);
    };
    CharUnicodeInfo.h = function (a, b) {
        return CharUnicodeInfo.g(a.charAt(b));
    };
    CharUnicodeInfo.i = function (a) {
        throw new NotImplementedException(0);
    };
    CharUnicodeInfo.j = function (a, b) {
        return CharUnicodeInfo.i(a.charAt(b));
    };
    CharUnicodeInfo.c = function (a) {
        throw new NotImplementedException(0);
    };
    CharUnicodeInfo.d = function (a, b) {
        return CharUnicodeInfo.c(a.charAt(b));
    };
    CharUnicodeInfo.e = function (a) {
    ...
    CharUnicodeInfo.a = function (a, b) {
        var c = "\\p{" + a + "}";
        return (unicode_hack(c).test(b));
    };
    CharUnicodeInfo.f = function (a, b) {
        return CharUnicodeInfo.e(a.charAt(b));
    };
    CharUnicodeInfo.b = function (a) {
