 ...
 * @hidden
 */
var CT_Shape_Chart = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CT_Shape_Chart, _super);
    function CT_Shape_Chart() {
        var _this = _super.call(this) || this;
        _this.c = 0;
        return _this;
    }
    Object.defineProperty(CT_Shape_Chart.prototype, "b", {
        get: function () {
            return this.c;
        },
        set: function (a) {
    ...
    CT_Shape_Chart.f = function (a, b, c) {
        a.ad.p(b, "c");
        var d = null;
        var e = null;
        e = "val";
        d = XmlNamespaceDefinitionBase.p(ST_Shape_$type, c);
        a.ad.h(e, d);
        ;
    };
    CT_Shape_Chart.prototype.toString = function () {
    ...
    return CT_Shape_Chart;
}(Base));
export { CT_Shape_Chart };
