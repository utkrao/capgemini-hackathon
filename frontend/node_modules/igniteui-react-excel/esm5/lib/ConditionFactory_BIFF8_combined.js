 ...
 * @hidden
 */
var ConditionFactory_BIFF8 = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ConditionFactory_BIFF8, _super);
    function ConditionFactory_BIFF8() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ConditionFactory_BIFF8.i = function (a, b) {
        var c = toNullable(FormatConditionType_$type, null);
        if (b.hasValue) {
            switch (b.value) {
                case 25:
                case 29:
    ...
    ConditionFactory_BIFF8.j = function (a, b, c) {
        var d = new FormulaConditionalFormat(1, a.c, null, toNullable(CellReferenceMode_$type, null));
        ConditionFactory_BIFF8.s(d, b);
        ConditionFactory_BIFF8.t(d, b);
        var e = null;
 ...
 * @hidden
 */
var Extensions_BIFF8 = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(Extensions_BIFF8, _super);
    ...
    Extensions_BIFF8.d = function (a) {
        var b = toNullable(FormatConditionTimePeriod_$type, null);
