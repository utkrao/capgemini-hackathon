 ...
 * @hidden
 */
var ChartExElements = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ChartExElements, _super);
    function ChartExElements() {
    ...
    return ChartExElements;
}(Base));
export { ChartExElements };
