 ...
 */
import { Base, IEnumerable_$type, String_$type, markType, getEnumerator } from "igniteui-react-core";
import { AttDef } from "./AttDef";
import { Dictionary$2 } from "igniteui-react-core";
/**
 * @hidden
 */
var AttList = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(AttList, _super);
    function AttList() {
        var _this = _super.call(this) || this;
        _this._b = null;
        _this._b = new Dictionary$2(String_$type, AttDef.$, 0);
        return _this;
    }
    AttList.prototype._c = function (a) {
        this._b.addItem(a.f, a);
    };
    AttList.prototype._item = function (a) {
        return this._b.item(a);
    };
    AttList.prototype.getEnumeratorObject = function () {
