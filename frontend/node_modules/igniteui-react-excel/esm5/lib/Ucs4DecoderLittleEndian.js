 ...
 */
import { Ucs4Decoder } from "./Ucs4Decoder";
import { BaseError, markType } from "igniteui-react-core";
import { intSToU, intToString1 } from "igniteui-react-core";
/**
 * @hidden
 */
var Ucs4DecoderLittleEndian = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(Ucs4DecoderLittleEndian, _super);
    function Ucs4DecoderLittleEndian() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Ucs4DecoderLittleEndian.prototype._i = function (a, b, c, d, e) {
        var f;
        var g, h;
        c += b;
        for (g = b, h = e; g + 3 < c;) {
    ...
    return Ucs4DecoderLittleEndian;
}(Ucs4Decoder));
export { Ucs4DecoderLittleEndian };
