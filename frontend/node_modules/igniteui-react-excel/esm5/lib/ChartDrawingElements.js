 ...
 * @hidden
 */
var ChartDrawingElements = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ChartDrawingElements, _super);
    function ChartDrawingElements() {
    ...
    return ChartDrawingElements;
}(Base));
export { ChartDrawingElements };
