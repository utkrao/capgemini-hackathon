 ...
 * @hidden
 */
var Attribute = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Attribute.prototype.g = function (a, b, c) {
        this.e = a;
        this.d = b;
        this.c = c;
        this.a = null;
    };
    Object.defineProperty(Attribute.prototype, "f", {
        get: function () {
            if (this.d != null) {
                return this.d;
            }
    ...
    Object.defineProperty(Attribute.prototype, "b", {
        get: function () {
            return (this.d == null);
        },
        enumerable: false,
