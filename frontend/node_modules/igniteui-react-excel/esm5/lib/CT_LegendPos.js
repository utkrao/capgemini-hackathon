 ...
 * @hidden
 */
var CT_LegendPos = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CT_LegendPos, _super);
    function CT_LegendPos() {
        var _this = _super.call(this) || this;
        _this.c = 0;
        return _this;
    }
    Object.defineProperty(CT_LegendPos.prototype, "b", {
        get: function () {
            return this.c;
        },
        set: function (a) {
    ...
    CT_LegendPos.f = function (a, b, c) {
        a.ad.p(b, "c");
        var d = null;
        var e = null;
        e = "val";
        d = XmlNamespaceDefinitionBase.p(ST_LegendPos_$type, c);
        a.ad.h(e, d);
        ;
    };
    CT_LegendPos.prototype.toString = function () {
