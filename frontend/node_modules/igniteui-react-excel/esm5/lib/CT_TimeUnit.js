 ...
 * @hidden
 */
var CT_TimeUnit = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CT_TimeUnit, _super);
    function CT_TimeUnit() {
        var _this = _super.call(this) || this;
        _this.c = 0;
        return _this;
    }
    Object.defineProperty(CT_TimeUnit.prototype, "b", {
        get: function () {
            return this.c;
        },
        set: function (a) {
    ...
    CT_TimeUnit.f = function (a, b, c) {
        a.ad.p(b, "c");
        var d = null;
        var e = null;
        e = "val";
        d = XmlNamespaceDefinitionBase.p(ST_TimeUnit_$type, c);
        a.ad.h(e, d);
        ;
    };
    CT_TimeUnit.prototype.toString = function () {
