 ...
 * @hidden
 */
var CT_LuminanceEffect = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CT_LuminanceEffect, _super);
    function CT_LuminanceEffect() {
        var _this = _super.call(this) || this;
        _this.d = toNullable(Number_$type, null);
        _this.f = toNullable(Number_$type, null);
        return _this;
    }
    Object.defineProperty(CT_LuminanceEffect.prototype, "c", {
        get: function () {
            return this.d;
        },
        set: function (a) {
    ...
    Object.defineProperty(CT_LuminanceEffect.prototype, "e", {
        get: function () {
            return this.f;
        },
        set: function (a) {
    ...
    CT_LuminanceEffect.h = function (a, b, c) {
        var e_1, _a;
            ...
            for (var _b = __values(fromEnum(a.ab.u)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                switch (d.a.e(a.d)) {
                    case "bright":
                        ...
                        break;
                    case "contrast":
                        c = toNullable(Number_$type, parseInt32_1(d.d, CultureInfo.invariantCulture));
                        break;
                    default: break;
                }
            }
    ...
    CT_LuminanceEffect.i = function (a, b, c, d) {
        if (c === void 0) {
            c = toNullable(Number_$type, null);
        }
        if (d === void 0) {
    ...
    CT_LuminanceEffect.prototype.toString = function () {
