 ...
 * @hidden
 */
var Ucs4DecoderBigEngian = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(Ucs4DecoderBigEngian, _super);
    function Ucs4DecoderBigEngian() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Ucs4DecoderBigEngian.prototype._i = function (a, b, c, d, e) {
        var f;
        var g, h;
        c += b;
        for (g = b, h = e; g + 3 < c;) {
    ...
    return Ucs4DecoderBigEngian;
}(Ucs4Decoder));
export { Ucs4DecoderBigEngian };
