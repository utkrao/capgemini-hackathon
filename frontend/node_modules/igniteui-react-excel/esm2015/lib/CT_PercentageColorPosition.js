 ...
 * @hidden
 */
export let CT_PercentageColorPosition = /*@__PURE__*/ (() => {
    class CT_PercentageColorPosition extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_PercentageColorPosition.$t = /*@__PURE__*/ markType(CT_PercentageColorPosition, 'CT_PercentageColorPosition');
    return CT_PercentageColorPosition;
})();
