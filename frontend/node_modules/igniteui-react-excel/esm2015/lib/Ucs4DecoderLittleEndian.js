 ...
 * @hidden
 */
export let Ucs4DecoderLittleEndian = /*@__PURE__*/ (() => {
    class Ucs4DecoderLittleEndian extends Ucs4Decoder {
        _i(a, b, c, d, e) {
            let f;
            let g, h;
            c += b;
    ...
    Ucs4DecoderLittleEndian.$t = /*@__PURE__*/ markType(Ucs4DecoderLittleEndian, 'Ucs4DecoderLittleEndian', Ucs4Decoder.$);
