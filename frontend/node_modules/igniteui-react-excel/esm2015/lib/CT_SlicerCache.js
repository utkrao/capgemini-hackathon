 ...
 * @hidden
 */
export let CT_SlicerCache = /*@__PURE__*/ (() => {
    class CT_SlicerCache extends Base {
        constructor() {
            super(...arguments);
            this.b = null;
        }
    ...
    CT_SlicerCache.$t = /*@__PURE__*/ markType(CT_SlicerCache, 'CT_SlicerCache');
    return CT_SlicerCache;
})();
