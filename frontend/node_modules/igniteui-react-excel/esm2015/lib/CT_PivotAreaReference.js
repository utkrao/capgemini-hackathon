 ...
 * @hidden
 */
export let CT_PivotAreaReference = /*@__PURE__*/ (() => {
    class CT_PivotAreaReference extends Base {
        constructor() {
            super();
            this.af = null;
            this.a = null;
    ...
    CT_PivotAreaReference.$t = /*@__PURE__*/ markType(CT_PivotAreaReference, 'CT_PivotAreaReference', Base.$, [ISupportSetProperty_$type]);
