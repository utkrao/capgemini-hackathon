...
import { CT_TableCol } from "./CT_TableCol";
/**
 * @hidden
 */
export let CT_TableGrid = /*@__PURE__*/ (() => {
    class CT_TableGrid extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_TableGrid.$t = /*@__PURE__*/ markType(CT_TableGrid, 'CT_TableGrid', Base.$, [ISupportSetProperty_$type]);
    return CT_TableGrid;
})();
