 ...
 * @hidden
 */
export let UltraCalcFunctionATan2 = /*@__PURE__*/ (() => {
    class UltraCalcFunctionATan2 extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            let d = a.pop();
            if (d.isError) {
    ...
    UltraCalcFunctionATan2.$t = /*@__PURE__*/ markType(UltraCalcFunctionATan2, 'UltraCalcFunctionATan2', BuiltInFunctionBase.$);
