 ...
 * @hidden
 */
export let UltraCalcFunctionSecond = /*@__PURE__*/ (() => {
    class UltraCalcFunctionSecond extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionSecond.$t = /*@__PURE__*/ markType(UltraCalcFunctionSecond, 'UltraCalcFunctionSecond', BuiltInFunctionBase.$);
