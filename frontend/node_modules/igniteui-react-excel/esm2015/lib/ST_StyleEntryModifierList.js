 ...
 * @hidden
 */
export let ST_StyleEntryModifierList = /*@__PURE__*/ (() => {
    class ST_StyleEntryModifierList extends Base {
        constructor() {
            super(...arguments);
            this.c = null;
        }
    ...
    ST_StyleEntryModifierList.$t = /*@__PURE__*/ markType(ST_StyleEntryModifierList, 'ST_StyleEntryModifierList');
