 ...
 * @hidden
 */
export let CT_PivotAreas = /*@__PURE__*/ (() => {
    class CT_PivotAreas extends Base {
        constructor() {
            super();
            this.b = null;
            this.e = 0;
    ...
    CT_PivotAreas.$t = /*@__PURE__*/ markType(CT_PivotAreas, 'CT_PivotAreas', Base.$, [ISupportSetProperty_$type]);
