...
import { ST_ErrBarType_$type } from "./ST_ErrBarType";
import { XmlNamespaceDefinitionBase } from "./XmlNamespaceDefinitionBase";
/**
 * @hidden
 */
export let CT_ErrBarType = /*@__PURE__*/ (() => {
    class CT_ErrBarType extends Base {
        constructor() {
            super();
            this.c = 0;
        }
        ...
        static f(a, b, c) {
            ...
            let e = null;
            e = "val";
            d = XmlNamespaceDefinitionBase.p(ST_ErrBarType_$type, c);
            a.ad.h(e, d);
            ;
        }
        toString() {
    ...
    CT_ErrBarType.$t = /*@__PURE__*/ markType(CT_ErrBarType, 'CT_ErrBarType');
