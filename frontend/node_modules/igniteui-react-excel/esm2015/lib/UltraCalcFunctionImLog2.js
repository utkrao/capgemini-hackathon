 ...
 * @hidden
 */
export let UltraCalcFunctionImLog2 = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImLog2 extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImLog2.$t = /*@__PURE__*/ markType(UltraCalcFunctionImLog2, 'UltraCalcFunctionImLog2', BuiltInFunctionBase.$);
