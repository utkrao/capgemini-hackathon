 ...
 * @hidden
 */
export let CT_DefaultShapeDefinition = /*@__PURE__*/ (() => {
    class CT_DefaultShapeDefinition extends Base {
        constructor() {
            super();
            this.d = null;
            this.f = null;
    ...
    CT_DefaultShapeDefinition.$t = /*@__PURE__*/ markType(CT_DefaultShapeDefinition, 'CT_DefaultShapeDefinition', Base.$, [ISupportSetProperty_$type]);
