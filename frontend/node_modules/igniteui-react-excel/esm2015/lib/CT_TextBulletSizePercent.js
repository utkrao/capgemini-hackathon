 ...
 * @hidden
 */
export let CT_TextBulletSizePercent = /*@__PURE__*/ (() => {
    class CT_TextBulletSizePercent extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_TextBulletSizePercent.$t = /*@__PURE__*/ markType(CT_TextBulletSizePercent, 'CT_TextBulletSizePercent');
