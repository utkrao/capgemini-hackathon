 ...
 * @hidden
 */
export let CT_CustomColorList = /*@__PURE__*/ (() => {
    class CT_CustomColorList extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_CustomColorList.$t = /*@__PURE__*/ markType(CT_CustomColorList, 'CT_CustomColorList', Base.$, [ISupportSetProperty_$type]);
