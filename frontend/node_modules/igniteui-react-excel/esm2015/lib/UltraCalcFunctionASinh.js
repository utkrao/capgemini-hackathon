 ...
 * @hidden
 */
export let UltraCalcFunctionASinh = /*@__PURE__*/ (() => {
    class UltraCalcFunctionASinh extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionASinh.$t = /*@__PURE__*/ markType(UltraCalcFunctionASinh, 'UltraCalcFunctionASinh', BuiltInFunctionBase.$);
