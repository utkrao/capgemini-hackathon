 ...
 * @hidden
 */
export let UltraCalcFunctionFloor = /*@__PURE__*/ (() => {
    class UltraCalcFunctionFloor extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = 1;
            if (b > 1) {
                let d = a.pop();
    ...
    UltraCalcFunctionFloor.$t = /*@__PURE__*/ markType(UltraCalcFunctionFloor, 'UltraCalcFunctionFloor', BuiltInFunctionBase.$);
