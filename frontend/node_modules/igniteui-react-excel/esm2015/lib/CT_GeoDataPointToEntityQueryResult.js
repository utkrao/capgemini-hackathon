 ...
 * @hidden
 */
export let CT_GeoDataPointToEntityQueryResult = /*@__PURE__*/ (() => {
    class CT_GeoDataPointToEntityQueryResult extends Base {
        constructor() {
            super();
            this.b = null;
            this.d = null;
    ...
    CT_GeoDataPointToEntityQueryResult.$t = /*@__PURE__*/ markType(CT_GeoDataPointToEntityQueryResult, 'CT_GeoDataPointToEntityQueryResult', Base.$, [ISupportSetProperty_$type]);
    return CT_GeoDataPointToEntityQueryResult;
})();
