 ...
 * @hidden
 */
export let CT_PivotAreaReferences = /*@__PURE__*/ (() => {
    class CT_PivotAreaReferences extends Base {
        constructor() {
            super();
            this.a = null;
            this.c = 0;
    ...
    CT_PivotAreaReferences.$t = /*@__PURE__*/ markType(CT_PivotAreaReferences, 'CT_PivotAreaReferences', Base.$, [ISupportSetProperty_$type]);
