 ...
 * @hidden
 */
export let CT_BarDir = /*@__PURE__*/ (() => {
    class CT_BarDir extends Base {
        constructor() {
            super();
            this.c = 0;
        }
        ...
        static f(a, b, c) {
            ...
            let e = null;
            e = "val";
            d = XmlNamespaceDefinitionBase.p(ST_BarDir_$type, c);
            a.ad.h(e, d);
            ;
        }
        toString() {
    ...
    CT_BarDir.$t = /*@__PURE__*/ markType(CT_BarDir, 'CT_BarDir');
    return CT_BarDir;
})();
