 ...
 * @hidden
 */
export let CT_ColorSchemeList = /*@__PURE__*/ (() => {
    class CT_ColorSchemeList extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_ColorSchemeList.$t = /*@__PURE__*/ markType(CT_ColorSchemeList, 'CT_ColorSchemeList', Base.$, [ISupportSetProperty_$type]);
