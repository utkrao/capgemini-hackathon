 ...
 * @hidden
 */
export let UltraCalcFunctionSecH = /*@__PURE__*/ (() => {
    class UltraCalcFunctionSecH extends BuiltInFunctionBase {
        evaluate(a, b) {
    ...
    UltraCalcFunctionSecH.$t = /*@__PURE__*/ markType(UltraCalcFunctionSecH, 'UltraCalcFunctionSecH', BuiltInFunctionBase.$);
