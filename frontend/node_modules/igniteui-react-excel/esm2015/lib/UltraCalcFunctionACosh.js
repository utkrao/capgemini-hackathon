 ...
 * @hidden
 */
export let UltraCalcFunctionACosh = /*@__PURE__*/ (() => {
    class UltraCalcFunctionACosh extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionACosh.$t = /*@__PURE__*/ markType(UltraCalcFunctionACosh, 'UltraCalcFunctionACosh', BuiltInFunctionBase.$);
