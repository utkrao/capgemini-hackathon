 ...
 * @hidden
 */
export let CT_TupleSetRow = /*@__PURE__*/ (() => {
    class CT_TupleSetRow extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_TupleSetRow.$t = /*@__PURE__*/ markType(CT_TupleSetRow, 'CT_TupleSetRow');
    return CT_TupleSetRow;
})();
