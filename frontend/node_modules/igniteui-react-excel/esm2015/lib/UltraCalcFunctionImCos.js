 ...
 * @hidden
 */
export let UltraCalcFunctionImCos = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImCos extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImCos.$t = /*@__PURE__*/ markType(UltraCalcFunctionImCos, 'UltraCalcFunctionImCos', BuiltInFunctionBase.$);
