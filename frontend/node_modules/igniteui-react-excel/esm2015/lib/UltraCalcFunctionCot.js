 ...
 * @hidden
 */
export let UltraCalcFunctionCot = /*@__PURE__*/ (() => {
    class UltraCalcFunctionCot extends BuiltInFunctionBase {
        evaluate(a, b) {
    ...
    UltraCalcFunctionCot.$t = /*@__PURE__*/ markType(UltraCalcFunctionCot, 'UltraCalcFunctionCot', BuiltInFunctionBase.$);
