 ...
 * @hidden
 */
export let CT_RelativeOffsetEffect = /*@__PURE__*/ (() => {
    class CT_RelativeOffsetEffect extends Base {
        constructor() {
            super();
        ...
        static i(a, b, c = toNullable(Number_$type, null), d = toNullable(Number_$type, null)) {
            a.ad.p(b, "a");
            let e = null;
            let f = null;
            if (c.hasValue) {
    ...
    CT_RelativeOffsetEffect.$t = /*@__PURE__*/ markType(CT_RelativeOffsetEffect, 'CT_RelativeOffsetEffect');
