 ...
 * @hidden
 */
export let CT_PictureStackUnit = /*@__PURE__*/ (() => {
    class CT_PictureStackUnit extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_PictureStackUnit.$t = /*@__PURE__*/ markType(CT_PictureStackUnit, 'CT_PictureStackUnit');
