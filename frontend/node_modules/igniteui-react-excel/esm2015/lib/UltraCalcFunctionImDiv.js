 ...
 * @hidden
 */
export let UltraCalcFunctionImDiv = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImDiv extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImDiv.$t = /*@__PURE__*/ markType(UltraCalcFunctionImDiv, 'UltraCalcFunctionImDiv', BuiltInFunctionBase.$);
