 ...
 * @hidden
 */
export let CT_AlphaOutsetEffect = /*@__PURE__*/ (() => {
    class CT_AlphaOutsetEffect extends Base {
        constructor() {
            super();
    ...
    CT_AlphaOutsetEffect.$t = /*@__PURE__*/ markType(CT_AlphaOutsetEffect, 'CT_AlphaOutsetEffect');
