 ...
 * @hidden
 */
export let CT_TextBulletSizePoint = /*@__PURE__*/ (() => {
    class CT_TextBulletSizePoint extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_TextBulletSizePoint.$t = /*@__PURE__*/ markType(CT_TextBulletSizePoint, 'CT_TextBulletSizePoint');
