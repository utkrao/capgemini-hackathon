 ...
 * @hidden
 */
export let CT_TextSpacingPercent = /*@__PURE__*/ (() => {
    class CT_TextSpacingPercent extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_TextSpacingPercent.$t = /*@__PURE__*/ markType(CT_TextSpacingPercent, 'CT_TextSpacingPercent');
