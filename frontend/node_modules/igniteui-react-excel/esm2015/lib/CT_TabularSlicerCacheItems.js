 ...
 * @hidden
 */
export let CT_TabularSlicerCacheItems = /*@__PURE__*/ (() => {
    class CT_TabularSlicerCacheItems extends Base {
        constructor() {
            super();
            this.b = null;
    ...
    CT_TabularSlicerCacheItems.$t = /*@__PURE__*/ markType(CT_TabularSlicerCacheItems, 'CT_TabularSlicerCacheItems');
