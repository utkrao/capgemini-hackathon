 ...
 * @hidden
 */
export let CT_DataLabelHidden = /*@__PURE__*/ (() => {
    class CT_DataLabelHidden extends Base {
        constructor() {
            super(...arguments);
            this.c = 0;
        }
    ...
    CT_DataLabelHidden.$t = /*@__PURE__*/ markType(CT_DataLabelHidden, 'CT_DataLabelHidden');
