 ...
 * @hidden
 */
export let UltraCalcFunctionImExp = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImExp extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImExp.$t = /*@__PURE__*/ markType(UltraCalcFunctionImExp, 'UltraCalcFunctionImExp', BuiltInFunctionBase.$);
