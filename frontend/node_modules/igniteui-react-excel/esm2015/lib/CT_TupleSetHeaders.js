 ...
 * @hidden
 */
export let CT_TupleSetHeaders = /*@__PURE__*/ (() => {
    class CT_TupleSetHeaders extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_TupleSetHeaders.$t = /*@__PURE__*/ markType(CT_TupleSetHeaders, 'CT_TupleSetHeaders');
    return CT_TupleSetHeaders;
})();
