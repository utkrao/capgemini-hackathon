 ...
 * @hidden
 */
export let CT_AlphaReplaceEffect = /*@__PURE__*/ (() => {
    class CT_AlphaReplaceEffect extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_AlphaReplaceEffect.$t = /*@__PURE__*/ markType(CT_AlphaReplaceEffect, 'CT_AlphaReplaceEffect');
