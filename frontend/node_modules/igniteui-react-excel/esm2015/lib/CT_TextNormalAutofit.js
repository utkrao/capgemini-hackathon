 ...
 * @hidden
 */
export let CT_TextNormalAutofit = /*@__PURE__*/ (() => {
    class CT_TextNormalAutofit extends Base {
        constructor() {
            super();
    ...
    CT_TextNormalAutofit.$t = /*@__PURE__*/ markType(CT_TextNormalAutofit, 'CT_TextNormalAutofit');
