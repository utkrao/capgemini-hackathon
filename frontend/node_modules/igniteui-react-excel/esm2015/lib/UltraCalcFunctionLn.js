 ...
 * @hidden
 */
export let UltraCalcFunctionLn = /*@__PURE__*/ (() => {
    class UltraCalcFunctionLn extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionLn.$t = /*@__PURE__*/ markType(UltraCalcFunctionLn, 'UltraCalcFunctionLn', BuiltInFunctionBase.$);
