 ...
 * @hidden
 */
export let UltraCalcFunctionIsoCeiling = /*@__PURE__*/ (() => {
    class UltraCalcFunctionIsoCeiling extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = null;
            if (b == 2) {
                c = a.pop();
    ...
    UltraCalcFunctionIsoCeiling.$t = /*@__PURE__*/ markType(UltraCalcFunctionIsoCeiling, 'UltraCalcFunctionIsoCeiling', BuiltInFunctionBase.$);
