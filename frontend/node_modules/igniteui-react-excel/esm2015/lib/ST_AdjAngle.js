 ...
 * @hidden
 */
export let ST_AdjAngle = /*@__PURE__*/ (() => {
    class ST_AdjAngle extends ValueType {
        constructor(a, ..._rest) {
            super();
            this.b = toNullable(ST_Angle.$, null);
    ...
    ST_AdjAngle.$t = /*@__PURE__*/ markStruct(ST_AdjAngle, 'ST_AdjAngle');
    return ST_AdjAngle;
})();
