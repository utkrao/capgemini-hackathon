 ...
 * @hidden
 */
export let CT_CacheSourceExt = /*@__PURE__*/ (() => {
    class CT_CacheSourceExt extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_CacheSourceExt.$t = /*@__PURE__*/ markType(CT_CacheSourceExt, 'CT_CacheSourceExt');
    return CT_CacheSourceExt;
})();
