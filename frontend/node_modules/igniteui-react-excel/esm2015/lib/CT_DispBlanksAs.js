 ...
 * @hidden
 */
export let CT_DispBlanksAs = /*@__PURE__*/ (() => {
    class CT_DispBlanksAs extends Base {
        constructor() {
            super();
            this.c = 0;
        }
        ...
        static f(a, b, c) {
            ...
            let e = null;
            e = "val";
            d = XmlNamespaceDefinitionBase.p(ST_DispBlanksAs_$type, c);
            a.ad.h(e, d);
            ;
        }
        toString() {
    ...
    CT_DispBlanksAs.$t = /*@__PURE__*/ markType(CT_DispBlanksAs, 'CT_DispBlanksAs');
