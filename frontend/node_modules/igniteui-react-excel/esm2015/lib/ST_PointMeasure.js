 ...
 * @hidden
 */
export let ST_PointMeasure = /*@__PURE__*/ (() => {
    class ST_PointMeasure extends ValueType {
        constructor(a, ..._rest) {
            super();
        ...
        equals(a) {
            let b = toNullable(ST_PointMeasure.$, typeCast(ST_PointMeasure.$, a));
            if (ST_PointMeasure.j(b, toNullable(ST_PointMeasure.$, null))) {
                return false;
            }
        ...
        static p(a) {
            ...
            if (nullableNotEquals(b, null)) {
                return toNullable(ST_PointMeasure.$, ST_PointMeasure.a(b.getValueOrDefault()));
            }
            return toNullable(ST_PointMeasure.$, null);
        }
        static g(a, b) {
        ...
        static m(a) {
            ...
            return toNullable(ST_PointMeasure.$, ST_PointMeasure.a(a.value));
        }
        static e(a) {
            return a.d;
        }
        static n(a) {
            ...
            return toNullable(ST_UnsignedDecimalNumber.$, ST_PointMeasure.e(a.value));
        }
        static q(a) {
        ...
        static o(a) {
            ...
            return toNullable(Number_$type, ST_PointMeasure.q(a.value));
        }
    }
    ST_PointMeasure.$t = /*@__PURE__*/ markStruct(ST_PointMeasure, 'ST_PointMeasure');
    return ST_PointMeasure;
})();
