 ...
 * @hidden
 */
export let CT_TupleSetRows = /*@__PURE__*/ (() => {
    class CT_TupleSetRows extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_TupleSetRows.$t = /*@__PURE__*/ markType(CT_TupleSetRows, 'CT_TupleSetRows');
    return CT_TupleSetRows;
})();
