 ...
 * @hidden
 */
export let UltraCalcFunctionImArgument = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImArgument extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImArgument.$t = /*@__PURE__*/ markType(UltraCalcFunctionImArgument, 'UltraCalcFunctionImArgument', BuiltInFunctionBase.$);
