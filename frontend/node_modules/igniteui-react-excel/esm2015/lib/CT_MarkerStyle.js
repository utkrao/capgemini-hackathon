 ...
 * @hidden
 */
export let CT_MarkerStyle = /*@__PURE__*/ (() => {
    class CT_MarkerStyle extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
        ...
        static e(a, b, c) {
            ...
            let e = null;
            e = "val";
            d = XmlNamespaceDefinitionBase.p(ST_MarkerStyle_$type, c);
            a.ad.h(e, d);
            ;
        }
        toString() {
    ...
    CT_MarkerStyle.$t = /*@__PURE__*/ markType(CT_MarkerStyle, 'CT_MarkerStyle');
