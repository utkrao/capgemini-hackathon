 ...
 * @hidden
 */
export let CT_SlicerCaches = /*@__PURE__*/ (() => {
    class CT_SlicerCaches extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_SlicerCaches.$t = /*@__PURE__*/ markType(CT_SlicerCaches, 'CT_SlicerCaches');
    return CT_SlicerCaches;
})();
