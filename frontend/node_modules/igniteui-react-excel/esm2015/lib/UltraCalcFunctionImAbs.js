 ...
 * @hidden
 */
export let UltraCalcFunctionImAbs = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImAbs extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImAbs.$t = /*@__PURE__*/ markType(UltraCalcFunctionImAbs, 'UltraCalcFunctionImAbs', BuiltInFunctionBase.$);
