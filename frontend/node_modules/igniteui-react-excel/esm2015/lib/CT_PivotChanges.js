 ...
 * @hidden
 */
export let CT_PivotChanges = /*@__PURE__*/ (() => {
    class CT_PivotChanges extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_PivotChanges.$t = /*@__PURE__*/ markType(CT_PivotChanges, 'CT_PivotChanges');
    return CT_PivotChanges;
})();
