 ...
 * @hidden
 */
export let CT_GrayscaleEffect = /*@__PURE__*/ (() => {
    class CT_GrayscaleEffect extends Base {
        toString() {
            let a = getInstanceType(this);
            return a != null ? a.typeName : super.toString();
        }
    }
    CT_GrayscaleEffect.$t = /*@__PURE__*/ markType(CT_GrayscaleEffect, 'CT_GrayscaleEffect');
