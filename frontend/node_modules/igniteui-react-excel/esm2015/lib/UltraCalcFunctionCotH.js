 ...
 * @hidden
 */
export let UltraCalcFunctionCotH = /*@__PURE__*/ (() => {
    class UltraCalcFunctionCotH extends BuiltInFunctionBase {
        evaluate(a, b) {
    ...
    UltraCalcFunctionCotH.$t = /*@__PURE__*/ markType(UltraCalcFunctionCotH, 'UltraCalcFunctionCotH', BuiltInFunctionBase.$);
