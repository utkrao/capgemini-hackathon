 ...
 * @hidden
 */
export let CT_GeoChildEntities = /*@__PURE__*/ (() => {
    class CT_GeoChildEntities extends Base {
        constructor() {
            super();
            this.b = null;
        }
    ...
    CT_GeoChildEntities.$t = /*@__PURE__*/ markType(CT_GeoChildEntities, 'CT_GeoChildEntities', Base.$, [ISupportSetProperty_$type]);
    return CT_GeoChildEntities;
})();
