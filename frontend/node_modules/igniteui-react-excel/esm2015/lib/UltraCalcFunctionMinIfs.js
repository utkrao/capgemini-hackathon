 ...
 * @hidden
 */
export let UltraCalcFunctionMinIfs = /*@__PURE__*/ (() => {
    class UltraCalcFunctionMinIfs extends BuiltInFunctionBase {
        evaluate(a, b) {
    ...
    UltraCalcFunctionMinIfs.$t = /*@__PURE__*/ markType(UltraCalcFunctionMinIfs, 'UltraCalcFunctionMinIfs', BuiltInFunctionBase.$);
