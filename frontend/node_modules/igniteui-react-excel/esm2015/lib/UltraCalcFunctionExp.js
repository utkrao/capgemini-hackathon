 ...
 * @hidden
 */
export let UltraCalcFunctionExp = /*@__PURE__*/ (() => {
    class UltraCalcFunctionExp extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionExp.$t = /*@__PURE__*/ markType(UltraCalcFunctionExp, 'UltraCalcFunctionExp', BuiltInFunctionBase.$);
