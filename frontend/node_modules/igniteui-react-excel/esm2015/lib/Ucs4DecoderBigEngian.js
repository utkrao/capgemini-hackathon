 ...
 * @hidden
 */
export let Ucs4DecoderBigEngian = /*@__PURE__*/ (() => {
    class Ucs4DecoderBigEngian extends Ucs4Decoder {
        _i(a, b, c, d, e) {
            let f;
            let g, h;
            c += b;
    ...
    Ucs4DecoderBigEngian.$t = /*@__PURE__*/ markType(Ucs4DecoderBigEngian, 'Ucs4DecoderBigEngian', Ucs4Decoder.$);
