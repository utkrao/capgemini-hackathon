 ...
 * @hidden
 */
export let UltraCalcFunctionImLog10 = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImLog10 extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImLog10.$t = /*@__PURE__*/ markType(UltraCalcFunctionImLog10, 'UltraCalcFunctionImLog10', BuiltInFunctionBase.$);
