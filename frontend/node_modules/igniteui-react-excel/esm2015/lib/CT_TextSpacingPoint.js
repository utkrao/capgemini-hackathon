 ...
 * @hidden
 */
export let CT_TextSpacingPoint = /*@__PURE__*/ (() => {
    class CT_TextSpacingPoint extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_TextSpacingPoint.$t = /*@__PURE__*/ markType(CT_TextSpacingPoint, 'CT_TextSpacingPoint');
