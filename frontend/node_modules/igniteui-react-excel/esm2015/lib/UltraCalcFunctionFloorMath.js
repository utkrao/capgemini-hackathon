 ...
 * @hidden
 */
export let UltraCalcFunctionFloorMath = /*@__PURE__*/ (() => {
    class UltraCalcFunctionFloorMath extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = null;
            let d = null;
            if (b == 3) {
    ...
    UltraCalcFunctionFloorMath.$t = /*@__PURE__*/ markType(UltraCalcFunctionFloorMath, 'UltraCalcFunctionFloorMath', BuiltInFunctionBase.$);
