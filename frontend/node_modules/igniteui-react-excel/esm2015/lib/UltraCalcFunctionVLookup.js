 ...
 * @hidden
 */
export let UltraCalcFunctionVLookup = /*@__PURE__*/ (() => {
    class UltraCalcFunctionVLookup extends UltraCalcFunctionLookupBase {
        evaluate(a, b) {
            let c = null;
            if (b == 4) {
                c = a.pop();
    ...
    UltraCalcFunctionVLookup.$t = /*@__PURE__*/ markType(UltraCalcFunctionVLookup, 'UltraCalcFunctionVLookup', UltraCalcFunctionLookupBase.$);
