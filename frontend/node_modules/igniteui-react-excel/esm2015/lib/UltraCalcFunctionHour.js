 ...
 * @hidden
 */
export let UltraCalcFunctionHour = /*@__PURE__*/ (() => {
    class UltraCalcFunctionHour extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionHour.$t = /*@__PURE__*/ markType(UltraCalcFunctionHour, 'UltraCalcFunctionHour', BuiltInFunctionBase.$);
