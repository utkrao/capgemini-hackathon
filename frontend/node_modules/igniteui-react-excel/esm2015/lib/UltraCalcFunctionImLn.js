 ...
 * @hidden
 */
export let UltraCalcFunctionImLn = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImLn extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImLn.$t = /*@__PURE__*/ markType(UltraCalcFunctionImLn, 'UltraCalcFunctionImLn', BuiltInFunctionBase.$);
