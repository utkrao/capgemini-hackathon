 ...
 * @hidden
 */
export let UltraCalcFunctionImProduct = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImProduct extends BuiltInFunctionBase {
        evaluate(a, b) {
    ...
    UltraCalcFunctionImProduct.$t = /*@__PURE__*/ markType(UltraCalcFunctionImProduct, 'UltraCalcFunctionImProduct', BuiltInFunctionBase.$);
