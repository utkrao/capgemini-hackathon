 ...
 * @hidden
 */
export let StringUtilitiesSgml = /*@__PURE__*/ (() => {
    class StringUtilitiesSgml extends Base {
        static a(a, b) {
            return stringCompare1(a, b, StringUtilities.j) == 0;
        }
    }
    StringUtilitiesSgml.$t = /*@__PURE__*/ markType(StringUtilitiesSgml, 'StringUtilitiesSgml');
