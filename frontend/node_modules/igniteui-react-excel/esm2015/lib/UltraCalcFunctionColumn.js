 ...
 * @hidden
 */
export let UltraCalcFunctionColumn = /*@__PURE__*/ (() => {
    class UltraCalcFunctionColumn extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c;
            if (b == 0) {
    ...
    UltraCalcFunctionColumn.$t = /*@__PURE__*/ markType(UltraCalcFunctionColumn, 'UltraCalcFunctionColumn', BuiltInFunctionBase.$);
