 ...
 * @hidden
 */
export let UltraCalcFunctionImConjugate = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImConjugate extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImConjugate.$t = /*@__PURE__*/ markType(UltraCalcFunctionImConjugate, 'UltraCalcFunctionImConjugate', BuiltInFunctionBase.$);
