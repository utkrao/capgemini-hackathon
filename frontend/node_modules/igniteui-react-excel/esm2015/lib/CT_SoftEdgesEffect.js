 ...
 * @hidden
 */
export let CT_SoftEdgesEffect = /*@__PURE__*/ (() => {
    class CT_SoftEdgesEffect extends Base {
        constructor() {
            super(...arguments);
            this.b = 0;
        }
    ...
    CT_SoftEdgesEffect.$t = /*@__PURE__*/ markType(CT_SoftEdgesEffect, 'CT_SoftEdgesEffect');
