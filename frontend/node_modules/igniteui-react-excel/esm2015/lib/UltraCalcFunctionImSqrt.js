 ...
 * @hidden
 */
export let UltraCalcFunctionImSqrt = /*@__PURE__*/ (() => {
    class UltraCalcFunctionImSqrt extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
                return c;
    ...
    UltraCalcFunctionImSqrt.$t = /*@__PURE__*/ markType(UltraCalcFunctionImSqrt, 'UltraCalcFunctionImSqrt', BuiltInFunctionBase.$);
