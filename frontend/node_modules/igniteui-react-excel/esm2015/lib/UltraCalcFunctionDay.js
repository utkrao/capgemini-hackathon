 ...
 * @hidden
 */
export let UltraCalcFunctionDay = /*@__PURE__*/ (() => {
    class UltraCalcFunctionDay extends BuiltInFunctionBase {
        evaluate(a, b) {
            let c = a.pop();
            if (c.isError) {
    ...
    UltraCalcFunctionDay.$t = /*@__PURE__*/ markType(UltraCalcFunctionDay, 'UltraCalcFunctionDay', BuiltInFunctionBase.$);
