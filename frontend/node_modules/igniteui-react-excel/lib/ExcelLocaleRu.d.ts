export declare class ExcelLocaleRu {
    [key: string]: string;
    ...
    "LE_ChartGradientFill_EmptyStops1": string;
    ...
    "LE_FormulaParseException_InvalidConditionalFormatFormula1": string;
    ...
    "LE_GradientStop_InvalidPosition1": string;
