...
var CalculatedColumnDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CalculatedColumnDescriptionMetadata, _super);
    ...
    CalculatedColumnDescriptionMetadata.b = function (a) {
        ...
        if (a.g(CalculatedColumnDescriptionMetadata.a)) {
            return;
        }
        a.s(CalculatedColumnDescriptionMetadata.a);
    };
    ...
    CalculatedColumnDescriptionMetadata.d = function (a) {
        ...
        a.u("CalculatedColumn", function () { return new CalculatedColumnDescription(); });
        a.t("CalculatedColumn", CalculatedColumnDescriptionMetadata.a);
    };
