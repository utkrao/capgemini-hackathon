...
var AbsoluteVolumeOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(AbsoluteVolumeOscillatorIndicatorDescriptionMetadata, _super);
    ...
    AbsoluteVolumeOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(AbsoluteVolumeOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(AbsoluteVolumeOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    AbsoluteVolumeOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("AbsoluteVolumeOscillatorIndicator", function () { return new AbsoluteVolumeOscillatorIndicatorDescription(); });
        a.t("AbsoluteVolumeOscillatorIndicator", AbsoluteVolumeOscillatorIndicatorDescriptionMetadata.a);
    };
