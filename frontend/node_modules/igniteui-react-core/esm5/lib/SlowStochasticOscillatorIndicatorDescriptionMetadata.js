...
var SlowStochasticOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SlowStochasticOscillatorIndicatorDescriptionMetadata, _super);
    ...
    SlowStochasticOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SlowStochasticOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(SlowStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    SlowStochasticOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("SlowStochasticOscillatorIndicator", function () { return new SlowStochasticOscillatorIndicatorDescription(); });
        a.t("SlowStochasticOscillatorIndicator", SlowStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
