...
var LegendMouseEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(LegendMouseEventArgsDescriptionMetadata, _super);
    ...
    LegendMouseEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(LegendMouseEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(LegendMouseEventArgsDescriptionMetadata.a);
    };
    ...
    LegendMouseEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("LegendMouseEventArgs", function () { return new LegendMouseEventArgsDescription(); });
        a.t("LegendMouseEventArgs", LegendMouseEventArgsDescriptionMetadata.a);
    };
