...
var ColumnExchangerDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ColumnExchangerDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ColumnExchangerDescriptionMetadata.a)) {
            return;
        }
        a.s(ColumnExchangerDescriptionMetadata.a);
    };
    ...
    ColumnExchangerDescriptionMetadata.d = function (a) {
        ...
        a.u("ColumnExchanger", function () { return new ColumnExchangerDescription(); });
        a.t("ColumnExchanger", ColumnExchangerDescriptionMetadata.a);
    };
