...
var GridFilterExpressionsEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(GridFilterExpressionsEventArgsDescriptionMetadata, _super);
    ...
    GridFilterExpressionsEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridFilterExpressionsEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridFilterExpressionsEventArgsDescriptionMetadata.a);
    };
    ...
    GridFilterExpressionsEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridFilterExpressionsEventArgs", function () { return new GridFilterExpressionsEventArgsDescription(); });
        a.t("GridFilterExpressionsEventArgs", GridFilterExpressionsEventArgsDescriptionMetadata.a);
    };
