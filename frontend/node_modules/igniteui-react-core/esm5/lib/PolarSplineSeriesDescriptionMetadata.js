...
var PolarSplineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PolarSplineSeriesDescriptionMetadata, _super);
    ...
    PolarSplineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PolarSplineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(PolarSplineSeriesDescriptionMetadata.a);
    };
    ...
    PolarSplineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("PolarSplineSeries", function () { return new PolarSplineSeriesDescription(); });
        a.t("PolarSplineSeries", PolarSplineSeriesDescriptionMetadata.a);
    };
