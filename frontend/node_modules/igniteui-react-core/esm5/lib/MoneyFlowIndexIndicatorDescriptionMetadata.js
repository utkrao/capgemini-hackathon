...
var MoneyFlowIndexIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(MoneyFlowIndexIndicatorDescriptionMetadata, _super);
    ...
    MoneyFlowIndexIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(MoneyFlowIndexIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(MoneyFlowIndexIndicatorDescriptionMetadata.a);
    };
    ...
    MoneyFlowIndexIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("MoneyFlowIndexIndicator", function () { return new MoneyFlowIndexIndicatorDescription(); });
        a.t("MoneyFlowIndexIndicator", MoneyFlowIndexIndicatorDescriptionMetadata.a);
    };
