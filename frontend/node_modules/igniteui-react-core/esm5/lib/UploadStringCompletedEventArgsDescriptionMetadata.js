...
var UploadStringCompletedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(UploadStringCompletedEventArgsDescriptionMetadata, _super);
    ...
    UploadStringCompletedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(UploadStringCompletedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(UploadStringCompletedEventArgsDescriptionMetadata.a);
    };
    ...
    UploadStringCompletedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("UploadStringCompletedEventArgs", function () { return new UploadStringCompletedEventArgsDescription(); });
        a.t("UploadStringCompletedEventArgs", UploadStringCompletedEventArgsDescriptionMetadata.a);
    };
