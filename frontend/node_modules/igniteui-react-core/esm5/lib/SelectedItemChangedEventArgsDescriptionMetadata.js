...
var SelectedItemChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SelectedItemChangedEventArgsDescriptionMetadata, _super);
    ...
    SelectedItemChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SelectedItemChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(SelectedItemChangedEventArgsDescriptionMetadata.a);
    };
    ...
    SelectedItemChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("SelectedItemChangedEventArgs", function () { return new SelectedItemChangedEventArgsDescription(); });
        a.t("SelectedItemChangedEventArgs", SelectedItemChangedEventArgsDescriptionMetadata.a);
    };
