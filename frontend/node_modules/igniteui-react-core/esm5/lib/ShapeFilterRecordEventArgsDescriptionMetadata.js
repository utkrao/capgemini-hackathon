...
var ShapeFilterRecordEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ShapeFilterRecordEventArgsDescriptionMetadata, _super);
    ...
    ShapeFilterRecordEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ShapeFilterRecordEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(ShapeFilterRecordEventArgsDescriptionMetadata.a);
    ...
    ShapeFilterRecordEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("ShapeFilterRecordEventArgs", function () { return new ShapeFilterRecordEventArgsDescription(); });
        a.t("ShapeFilterRecordEventArgs", ShapeFilterRecordEventArgsDescriptionMetadata.a);
    };
