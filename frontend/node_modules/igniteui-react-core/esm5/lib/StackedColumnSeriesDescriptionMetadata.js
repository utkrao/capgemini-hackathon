...
var StackedColumnSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    StackedColumnSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(StackedColumnSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(StackedColumnSeriesDescriptionMetadata.a);
    };
    ...
    StackedColumnSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("StackedColumnSeries", function () { return new StackedColumnSeriesDescription(); });
        a.t("StackedColumnSeries", StackedColumnSeriesDescriptionMetadata.a);
    };
