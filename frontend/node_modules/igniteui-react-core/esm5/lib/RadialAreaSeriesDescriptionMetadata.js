...
var RadialAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RadialAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RadialAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(RadialAreaSeriesDescriptionMetadata.a);
    };
    ...
    RadialAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("RadialAreaSeries", function () { return new RadialAreaSeriesDescription(); });
        a.t("RadialAreaSeries", RadialAreaSeriesDescriptionMetadata.a);
    };
