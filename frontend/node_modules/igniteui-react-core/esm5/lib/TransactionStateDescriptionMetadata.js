...
var TransactionStateDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TransactionStateDescriptionMetadata, _super);
    ...
    TransactionStateDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TransactionStateDescriptionMetadata.a)) {
            return;
        }
        a.s(TransactionStateDescriptionMetadata.a);
    };
    ...
    TransactionStateDescriptionMetadata.d = function (a) {
        ...
        a.u("TransactionState", function () { return new TransactionStateDescription(); });
        a.t("TransactionState", TransactionStateDescriptionMetadata.a);
    };
