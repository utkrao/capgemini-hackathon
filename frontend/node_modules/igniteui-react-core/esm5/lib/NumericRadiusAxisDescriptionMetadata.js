...
var NumericRadiusAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(NumericRadiusAxisDescriptionMetadata, _super);
    ...
    NumericRadiusAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.g(NumericRadiusAxisDescriptionMetadata.a)) {
            return;
        }
        a.s(NumericRadiusAxisDescriptionMetadata.a);
    };
    ...
    NumericRadiusAxisDescriptionMetadata.d = function (a) {
        ...
        a.u("NumericRadiusAxis", function () { return new NumericRadiusAxisDescription(); });
        a.t("NumericRadiusAxis", NumericRadiusAxisDescriptionMetadata.a);
    };
