...
var ChaikinOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ChaikinOscillatorIndicatorDescriptionMetadata, _super);
    ...
    ChaikinOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ChaikinOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(ChaikinOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    ChaikinOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("ChaikinOscillatorIndicator", function () { return new ChaikinOscillatorIndicatorDescription(); });
        a.t("ChaikinOscillatorIndicator", ChaikinOscillatorIndicatorDescriptionMetadata.a);
    };
