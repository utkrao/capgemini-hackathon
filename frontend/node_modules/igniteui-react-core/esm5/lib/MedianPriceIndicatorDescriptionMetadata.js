...
var MedianPriceIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(MedianPriceIndicatorDescriptionMetadata, _super);
    ...
    MedianPriceIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(MedianPriceIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(MedianPriceIndicatorDescriptionMetadata.a);
    };
    ...
    MedianPriceIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("MedianPriceIndicator", function () { return new MedianPriceIndicatorDescription(); });
        a.t("MedianPriceIndicator", MedianPriceIndicatorDescriptionMetadata.a);
    };
