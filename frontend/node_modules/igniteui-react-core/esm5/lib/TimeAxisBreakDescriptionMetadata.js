...
var TimeAxisBreakDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TimeAxisBreakDescriptionMetadata, _super);
    ...
    TimeAxisBreakDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TimeAxisBreakDescriptionMetadata.a)) {
            return;
        }
        a.s(TimeAxisBreakDescriptionMetadata.a);
    };
    ...
    TimeAxisBreakDescriptionMetadata.d = function (a) {
        ...
        a.u("TimeAxisBreak", function () { return new TimeAxisBreakDescription(); });
        a.t("TimeAxisBreak", TimeAxisBreakDescriptionMetadata.a);
    };
