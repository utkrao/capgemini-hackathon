...
var ScatterSplineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ScatterSplineSeriesDescriptionMetadata, _super);
    ...
    ScatterSplineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ScatterSplineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(ScatterSplineSeriesDescriptionMetadata.a);
    };
    ...
    ScatterSplineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("ScatterSplineSeries", function () { return new ScatterSplineSeriesDescription(); });
        a.t("ScatterSplineSeries", ScatterSplineSeriesDescriptionMetadata.a);
    };
