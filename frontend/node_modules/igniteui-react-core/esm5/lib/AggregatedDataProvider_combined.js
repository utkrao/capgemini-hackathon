...
var AggregatedDataProvider = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(AggregatedDataProvider.prototype, "f", {
        ...
        set: function (a) {
            ...
            this.c = a;
            if (b != this.c) {
                this.ah("TargetDataSource", b, this.c);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(AggregatedDataProvider.prototype, "m", {
        ...
        set: function (a) {
            ...
            this.j = a;
            if (b != this.j) {
                this.ah("IncludeParentSummary", b, this.r);
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(AggregatedDataProvider.prototype, "deferAutoRefresh", {
        ...
        set: function (a) {
            ...
            this.i = a;
            if (b != this.i) {
                this.ah("DeferAutoRefresh", b, this.i);
            }
        },
        enumerable: false,
        configurable: true
    ...
    AggregatedDataProvider.prototype.ah = function (a, b, c) {
        if (this.propertyChanged != null) {
            this.propertyChanged(this, new PropertyChangedEventArgs(a));
        }
        this.an(a, b, c);
    };
    AggregatedDataProvider.prototype.an = function (a, b, c) {
        switch (a) {
            case "ItemsSource":
                this.g.dataSource = c;
                break;
            ...
            case "TargetDataSource":
                if (b != null) {
                    ...
                    d.schemaChanged = delegateRemove(d.schemaChanged, runOn(this, this.ag));
                }
                if (c != null) {
                    var e = c;
                    ...
                    e.updateNotifier = f;
                    e.schemaChanged = delegateCombine(e.schemaChanged, runOn(this, this.ag));
                }
                this.queueAutoRefresh();
                break;
        }
    };
    AggregatedDataProvider.prototype.ag = function (a, b) {
        this.k = true;
        this.queueAutoRefresh();
    };
    ...
    AggregatedDataProvider.prototype.ao = function () {
        this.ap();
    };
    ...
    AggregatedDataProvider.prototype.d = function (a) {
        a.shouldEmitSummaryRows = true;
        a.includeSummaryRowsInSection = true;
        a.summaryScope = 2;
    ...
    AggregatedDataProvider.prototype.ad = function (a, b, c, d) {
        ...
        if (e != null) {
            for (var g = 0; g < f.length; g++) {
                var h = f[g];
                e.y(h.propertyName, g == 0 ? b.summaryDescriptions.k.item(g).alias : null, h.operand, h.value);
            }
        }
    };
    AggregatedDataProvider.prototype.ac = function (a, b, c) {
        ...
        for (var e = 0; e < d.length; e++) {
            var f = d[e];
            c.p(f.propertyName, e == 0 ? a.summaryDescriptions.k.item(e).alias : null, f.operand, f.value);
        }
    };
    ...
    AggregatedDataProvider.prototype.ai = function () {
        this.k = true;
        this.queueAutoRefresh();
    };
    AggregatedDataProvider.prototype.aj = function (a, b) {
        this.k = true;
        this.queueAutoRefresh();
    };
    ...
    AggregatedDataProvider.prototype.al = function (a, b, c) {
        this.k = true;
        this.queueAutoRefresh();
    };
    AggregatedDataProvider.prototype.am = function (a, b) {
        this.k = true;
        this.queueAutoRefresh();
    };
