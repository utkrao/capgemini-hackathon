...
var GridFilterDialogOpeningEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogOpeningEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridFilterDialogOpeningEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridFilterDialogOpeningEventArgsDescriptionMetadata.a);
    ...
    GridFilterDialogOpeningEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridFilterDialogOpeningEventArgs", function () { return new GridFilterDialogOpeningEventArgsDescription(); });
        a.t("GridFilterDialogOpeningEventArgs", GridFilterDialogOpeningEventArgsDescriptionMetadata.a);
    };
