...
var GridFilterDialogViewModelGroupingDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(GridFilterDialogViewModelGroupingDescriptionMetadata, _super);
    ...
    GridFilterDialogViewModelGroupingDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridFilterDialogViewModelGroupingDescriptionMetadata.a)) {
            return;
        }
        a.s(GridFilterDialogViewModelGroupingDescriptionMetadata.a);
    };
    ...
    GridFilterDialogViewModelGroupingDescriptionMetadata.d = function (a) {
        ...
        a.u("GridFilterDialogViewModelGrouping", function () { return new GridFilterDialogViewModelGroupingDescription(); });
        a.t("GridFilterDialogViewModelGrouping", GridFilterDialogViewModelGroupingDescriptionMetadata.a);
    };
