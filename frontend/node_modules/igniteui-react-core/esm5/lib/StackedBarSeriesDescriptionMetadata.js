...
var StackedBarSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(StackedBarSeriesDescriptionMetadata, _super);
    ...
    StackedBarSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(StackedBarSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(StackedBarSeriesDescriptionMetadata.a);
    };
    ...
    StackedBarSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("StackedBarSeries", function () { return new StackedBarSeriesDescription(); });
        a.t("StackedBarSeries", StackedBarSeriesDescriptionMetadata.a);
    };
