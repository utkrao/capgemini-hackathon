...
var LineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(LineSeriesDescriptionMetadata, _super);
    ...
    LineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(LineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(LineSeriesDescriptionMetadata.a);
    };
    ...
    LineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("LineSeries", function () { return new LineSeriesDescription(); });
        a.t("LineSeries", LineSeriesDescriptionMetadata.a);
    };
