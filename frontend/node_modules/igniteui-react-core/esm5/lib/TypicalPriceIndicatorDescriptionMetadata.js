...
var TypicalPriceIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TypicalPriceIndicatorDescriptionMetadata, _super);
    ...
    TypicalPriceIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TypicalPriceIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(TypicalPriceIndicatorDescriptionMetadata.a);
    };
    ...
    TypicalPriceIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("TypicalPriceIndicator", function () { return new TypicalPriceIndicatorDescription(); });
        a.t("TypicalPriceIndicator", TypicalPriceIndicatorDescriptionMetadata.a);
    };
