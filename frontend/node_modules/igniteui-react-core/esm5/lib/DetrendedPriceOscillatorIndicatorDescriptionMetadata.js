...
var DetrendedPriceOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(DetrendedPriceOscillatorIndicatorDescriptionMetadata, _super);
    ...
    DetrendedPriceOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DetrendedPriceOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(DetrendedPriceOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    DetrendedPriceOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("DetrendedPriceOscillatorIndicator", function () { return new DetrendedPriceOscillatorIndicatorDescription(); });
        a.t("DetrendedPriceOscillatorIndicator", DetrendedPriceOscillatorIndicatorDescriptionMetadata.a);
    };
