...
var PropertyUpdatedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PropertyUpdatedEventArgsDescriptionMetadata, _super);
    ...
    PropertyUpdatedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PropertyUpdatedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(PropertyUpdatedEventArgsDescriptionMetadata.a);
    };
    ...
    PropertyUpdatedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("PropertyUpdatedEventArgs", function () { return new PropertyUpdatedEventArgsDescription(); });
        a.t("PropertyUpdatedEventArgs", PropertyUpdatedEventArgsDescriptionMetadata.a);
    };
