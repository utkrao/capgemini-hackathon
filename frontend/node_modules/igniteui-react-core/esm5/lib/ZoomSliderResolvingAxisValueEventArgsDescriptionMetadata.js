...
var ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata, _super);
    ...
    ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.a);
    };
    ...
    ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("ZoomSliderResolvingAxisValueEventArgs", function () { return new ZoomSliderResolvingAxisValueEventArgsDescription(); });
        a.t("ZoomSliderResolvingAxisValueEventArgs", ZoomSliderResolvingAxisValueEventArgsDescriptionMetadata.a);
    };
