...
var PieSliceOthersContextDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PieSliceOthersContextDescriptionMetadata, _super);
    ...
    PieSliceOthersContextDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PieSliceOthersContextDescriptionMetadata.a)) {
            return;
        }
        a.s(PieSliceOthersContextDescriptionMetadata.a);
    };
    ...
    PieSliceOthersContextDescriptionMetadata.d = function (a) {
        ...
        a.u("PieSliceOthersContext", function () { return new PieSliceOthersContextDescription(); });
        a.t("PieSliceOthersContext", PieSliceOthersContextDescriptionMetadata.a);
    };
