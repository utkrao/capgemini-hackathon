...
var InputChangeEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(InputChangeEventArgsDescriptionMetadata, _super);
    ...
    InputChangeEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(InputChangeEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(InputChangeEventArgsDescriptionMetadata.a);
    };
    ...
    InputChangeEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("InputChangeEventArgs", function () { return new InputChangeEventArgsDescription(); });
        a.t("InputChangeEventArgs", InputChangeEventArgsDescriptionMetadata.a);
    };
