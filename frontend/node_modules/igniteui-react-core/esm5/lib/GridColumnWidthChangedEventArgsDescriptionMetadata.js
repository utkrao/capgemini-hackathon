...
var GridColumnWidthChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridColumnWidthChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridColumnWidthChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridColumnWidthChangedEventArgsDescriptionMetadata.a);
    ...
    GridColumnWidthChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridColumnWidthChangedEventArgs", function () { return new GridColumnWidthChangedEventArgsDescription(); });
        a.t("GridColumnWidthChangedEventArgs", GridColumnWidthChangedEventArgsDescriptionMetadata.a);
    };
