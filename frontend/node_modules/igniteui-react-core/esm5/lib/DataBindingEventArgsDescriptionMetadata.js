...
var DataBindingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(DataBindingEventArgsDescriptionMetadata, _super);
    ...
    DataBindingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DataBindingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(DataBindingEventArgsDescriptionMetadata.a);
    };
    ...
    DataBindingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("DataBindingEventArgs", function () { return new DataBindingEventArgsDescription(); });
        a.t("DataBindingEventArgs", DataBindingEventArgsDescriptionMetadata.a);
    };
