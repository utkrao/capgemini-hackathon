...
var ScatterSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ScatterSeriesDescriptionMetadata, _super);
    ...
    ScatterSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ScatterSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(ScatterSeriesDescriptionMetadata.a);
    };
    ...
    ScatterSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("ScatterSeries", function () { return new ScatterSeriesDescription(); });
        a.t("ScatterSeries", ScatterSeriesDescriptionMetadata.a);
    };
