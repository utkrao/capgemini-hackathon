...
var SectionFooterDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SectionFooterDescriptionMetadata, _super);
    ...
    SectionFooterDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SectionFooterDescriptionMetadata.a)) {
            return;
        }
        a.s(SectionFooterDescriptionMetadata.a);
    };
    ...
    SectionFooterDescriptionMetadata.d = function (a) {
        ...
        a.u("SectionFooter", function () { return new SectionFooterDescription(); });
        a.t("SectionFooter", SectionFooterDescriptionMetadata.a);
    };
