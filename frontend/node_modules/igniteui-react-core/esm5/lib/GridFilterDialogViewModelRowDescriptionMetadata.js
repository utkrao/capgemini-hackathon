...
var GridFilterDialogViewModelRowDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(GridFilterDialogViewModelRowDescriptionMetadata, _super);
    ...
    GridFilterDialogViewModelRowDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridFilterDialogViewModelRowDescriptionMetadata.a)) {
            return;
        }
        a.s(GridFilterDialogViewModelRowDescriptionMetadata.a);
    };
    ...
    GridFilterDialogViewModelRowDescriptionMetadata.d = function (a) {
        ...
        a.u("GridFilterDialogViewModelRow", function () { return new GridFilterDialogViewModelRowDescription(); });
        a.t("GridFilterDialogViewModelRow", GridFilterDialogViewModelRowDescriptionMetadata.a);
    };
