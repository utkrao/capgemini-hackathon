...
var CommodityChannelIndexIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CommodityChannelIndexIndicatorDescriptionMetadata, _super);
    ...
    CommodityChannelIndexIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(CommodityChannelIndexIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(CommodityChannelIndexIndicatorDescriptionMetadata.a);
    };
    ...
    CommodityChannelIndexIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("CommodityChannelIndexIndicator", function () { return new CommodityChannelIndexIndicatorDescription(); });
        a.t("CommodityChannelIndexIndicator", CommodityChannelIndexIndicatorDescriptionMetadata.a);
    };
