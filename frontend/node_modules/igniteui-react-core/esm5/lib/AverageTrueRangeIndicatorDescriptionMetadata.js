...
var AverageTrueRangeIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(AverageTrueRangeIndicatorDescriptionMetadata, _super);
    ...
    AverageTrueRangeIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(AverageTrueRangeIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(AverageTrueRangeIndicatorDescriptionMetadata.a);
    };
    ...
    AverageTrueRangeIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("AverageTrueRangeIndicator", function () { return new AverageTrueRangeIndicatorDescription(); });
        a.t("AverageTrueRangeIndicator", AverageTrueRangeIndicatorDescriptionMetadata.a);
    };
