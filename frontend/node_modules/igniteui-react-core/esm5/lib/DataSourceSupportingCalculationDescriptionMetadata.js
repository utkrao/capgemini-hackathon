...
var DataSourceSupportingCalculationDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(DataSourceSupportingCalculationDescriptionMetadata, _super);
    ...
    DataSourceSupportingCalculationDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DataSourceSupportingCalculationDescriptionMetadata.a)) {
            return;
        }
        a.s(DataSourceSupportingCalculationDescriptionMetadata.a);
    };
    ...
    DataSourceSupportingCalculationDescriptionMetadata.d = function (a) {
        ...
        a.u("DataSourceSupportingCalculation", function () { return new DataSourceSupportingCalculationDescription(); });
        a.t("DataSourceSupportingCalculation", DataSourceSupportingCalculationDescriptionMetadata.a);
    };
