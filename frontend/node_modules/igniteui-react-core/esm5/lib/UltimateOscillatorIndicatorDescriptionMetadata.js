...
var UltimateOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(UltimateOscillatorIndicatorDescriptionMetadata, _super);
    ...
    UltimateOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(UltimateOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(UltimateOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    UltimateOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("UltimateOscillatorIndicator", function () { return new UltimateOscillatorIndicatorDescription(); });
        a.t("UltimateOscillatorIndicator", UltimateOscillatorIndicatorDescriptionMetadata.a);
    };
