...
var RowSeparatorInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RowSeparatorInfoDescriptionMetadata, _super);
    ...
    RowSeparatorInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RowSeparatorInfoDescriptionMetadata.a)) {
            return;
        }
        a.s(RowSeparatorInfoDescriptionMetadata.a);
    };
    ...
    RowSeparatorInfoDescriptionMetadata.d = function (a) {
        ...
        a.u("RowSeparatorInfo", function () { return new RowSeparatorInfoDescription(); });
        a.t("RowSeparatorInfo", RowSeparatorInfoDescriptionMetadata.a);
    };
