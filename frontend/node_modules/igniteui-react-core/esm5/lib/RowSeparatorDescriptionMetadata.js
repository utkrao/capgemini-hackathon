...
var RowSeparatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RowSeparatorDescriptionMetadata, _super);
    ...
    RowSeparatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RowSeparatorDescriptionMetadata.a)) {
            return;
        }
        a.s(RowSeparatorDescriptionMetadata.a);
    };
    ...
    RowSeparatorDescriptionMetadata.d = function (a) {
        ...
        a.u("RowSeparator", function () { return new RowSeparatorDescription(); });
        a.t("RowSeparator", RowSeparatorDescriptionMetadata.a);
    };
