...
var TemplateHeaderCellUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata, _super);
    ...
    TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a);
    };
    ...
    TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("TemplateHeaderCellUpdatingEventArgs", function () { return new TemplateHeaderCellUpdatingEventArgsDescription(); });
        a.t("TemplateHeaderCellUpdatingEventArgs", TemplateHeaderCellUpdatingEventArgsDescriptionMetadata.a);
    };
