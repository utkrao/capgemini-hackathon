...
var CalloutStyleUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutStyleUpdatingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(CalloutStyleUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(CalloutStyleUpdatingEventArgsDescriptionMetadata.a);
    ...
    CalloutStyleUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("CalloutStyleUpdatingEventArgs", function () { return new CalloutStyleUpdatingEventArgsDescription(); });
        a.t("CalloutStyleUpdatingEventArgs", CalloutStyleUpdatingEventArgsDescriptionMetadata.a);
    };
