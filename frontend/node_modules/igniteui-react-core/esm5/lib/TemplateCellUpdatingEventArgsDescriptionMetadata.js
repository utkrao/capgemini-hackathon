...
var TemplateCellUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TemplateCellUpdatingEventArgsDescriptionMetadata, _super);
    ...
    TemplateCellUpdatingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TemplateCellUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(TemplateCellUpdatingEventArgsDescriptionMetadata.a);
    };
    ...
    TemplateCellUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("TemplateCellUpdatingEventArgs", function () { return new TemplateCellUpdatingEventArgsDescription(); });
        a.t("TemplateCellUpdatingEventArgs", TemplateCellUpdatingEventArgsDescriptionMetadata.a);
    };
