...
var NumericXAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(NumericXAxisDescriptionMetadata, _super);
    ...
    NumericXAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.g(NumericXAxisDescriptionMetadata.a)) {
            return;
        }
        a.s(NumericXAxisDescriptionMetadata.a);
    };
    ...
    NumericXAxisDescriptionMetadata.d = function (a) {
        ...
        a.u("NumericXAxis", function () { return new NumericXAxisDescription(); });
        a.t("NumericXAxis", NumericXAxisDescriptionMetadata.a);
    };
