...
var DataContextDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataContextDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DataContextDescriptionMetadata.a)) {
            return;
        }
        a.s(DataContextDescriptionMetadata.a);
    };
    ...
    DataContextDescriptionMetadata.d = function (a) {
        ...
        a.u("DataContext", function () { return new DataContextDescription(); });
        a.t("DataContext", DataContextDescriptionMetadata.a);
    };
