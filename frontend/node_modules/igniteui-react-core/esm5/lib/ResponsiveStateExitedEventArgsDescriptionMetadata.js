...
var ResponsiveStateExitedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ResponsiveStateExitedEventArgsDescriptionMetadata, _super);
    ...
    ResponsiveStateExitedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ResponsiveStateExitedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(ResponsiveStateExitedEventArgsDescriptionMetadata.a);
    };
    ...
    ResponsiveStateExitedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("ResponsiveStateExitedEventArgs", function () { return new ResponsiveStateExitedEventArgsDescription(); });
        a.t("ResponsiveStateExitedEventArgs", ResponsiveStateExitedEventArgsDescriptionMetadata.a);
    };
