...
var PropertyReferenceFilterExpressionDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PropertyReferenceFilterExpressionDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PropertyReferenceFilterExpressionDescriptionMetadata.a)) {
            return;
        }
        a.s(PropertyReferenceFilterExpressionDescriptionMetadata.a);
    };
    ...
    PropertyReferenceFilterExpressionDescriptionMetadata.d = function (a) {
        ...
        a.u("PropertyReferenceFilterExpression", function () { return new PropertyReferenceFilterExpressionDescription(); });
        a.t("PropertyReferenceFilterExpression", PropertyReferenceFilterExpressionDescriptionMetadata.a);
    };
