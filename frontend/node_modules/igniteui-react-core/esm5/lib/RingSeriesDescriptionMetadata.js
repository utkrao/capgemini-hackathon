...
var RingSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RingSeriesDescriptionMetadata, _super);
    ...
    RingSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RingSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(RingSeriesDescriptionMetadata.a);
    ...
    RingSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("RingSeries", function () { return new RingSeriesDescription(); });
        a.t("RingSeries", RingSeriesDescriptionMetadata.a);
    };
