...
var ColumnFilterConditionGroupDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ColumnFilterConditionGroupDescriptionMetadata, _super);
    ...
    ColumnFilterConditionGroupDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ColumnFilterConditionGroupDescriptionMetadata.a)) {
            return;
        }
        a.s(ColumnFilterConditionGroupDescriptionMetadata.a);
    ...
    ColumnFilterConditionGroupDescriptionMetadata.d = function (a) {
        ...
        a.u("ColumnFilterConditionGroup", function () { return new ColumnFilterConditionGroupDescription(); });
        a.t("ColumnFilterConditionGroup", ColumnFilterConditionGroupDescriptionMetadata.a);
    };
