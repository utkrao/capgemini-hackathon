...
var FastStochasticOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(FastStochasticOscillatorIndicatorDescriptionMetadata, _super);
    ...
    FastStochasticOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(FastStochasticOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(FastStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    FastStochasticOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("FastStochasticOscillatorIndicator", function () { return new FastStochasticOscillatorIndicatorDescription(); });
        a.t("FastStochasticOscillatorIndicator", FastStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
