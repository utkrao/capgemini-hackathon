...
var FinancialChartCustomIndicatorArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(FinancialChartCustomIndicatorArgsDescriptionMetadata, _super);
    ...
    FinancialChartCustomIndicatorArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(FinancialChartCustomIndicatorArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(FinancialChartCustomIndicatorArgsDescriptionMetadata.a);
    ...
    FinancialChartCustomIndicatorArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("FinancialChartCustomIndicatorArgs", function () { return new FinancialChartCustomIndicatorArgsDescription(); });
        a.t("FinancialChartCustomIndicatorArgs", FinancialChartCustomIndicatorArgsDescriptionMetadata.a);
    };
