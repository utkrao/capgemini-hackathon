...
var ImageCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ImageCellInfoDescriptionMetadata, _super);
    ...
    ImageCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ImageCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.s(ImageCellInfoDescriptionMetadata.a);
    };
    ...
    ImageCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.u("ImageCellInfo", function () { return new ImageCellInfoDescription(); });
        a.t("ImageCellInfo", ImageCellInfoDescriptionMetadata.a);
    };
