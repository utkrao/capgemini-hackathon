...
var TemplateSectionHeaderDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TemplateSectionHeaderDescriptionMetadata, _super);
    ...
    TemplateSectionHeaderDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TemplateSectionHeaderDescriptionMetadata.a)) {
            return;
        }
        a.s(TemplateSectionHeaderDescriptionMetadata.a);
    ...
    TemplateSectionHeaderDescriptionMetadata.d = function (a) {
        ...
        a.u("TemplateSectionHeader", function () { return new TemplateSectionHeaderDescription(); });
        a.t("TemplateSectionHeader", TemplateSectionHeaderDescriptionMetadata.a);
    };
