...
var GridFilterDialogViewModelDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogViewModelDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridFilterDialogViewModelDescriptionMetadata.a)) {
            return;
        }
        a.s(GridFilterDialogViewModelDescriptionMetadata.a);
    };
    ...
    GridFilterDialogViewModelDescriptionMetadata.d = function (a) {
        ...
        a.u("GridFilterDialogViewModel", function () { return new GridFilterDialogViewModelDescription(); });
        a.t("GridFilterDialogViewModel", GridFilterDialogViewModelDescriptionMetadata.a);
    };
