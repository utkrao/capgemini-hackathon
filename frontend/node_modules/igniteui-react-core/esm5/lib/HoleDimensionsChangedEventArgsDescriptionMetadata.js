...
var HoleDimensionsChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(HoleDimensionsChangedEventArgsDescriptionMetadata, _super);
    ...
    HoleDimensionsChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(HoleDimensionsChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(HoleDimensionsChangedEventArgsDescriptionMetadata.a);
    };
    ...
    HoleDimensionsChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("HoleDimensionsChangedEventArgs", function () { return new HoleDimensionsChangedEventArgsDescription(); });
        a.t("HoleDimensionsChangedEventArgs", HoleDimensionsChangedEventArgsDescriptionMetadata.a);
    };
