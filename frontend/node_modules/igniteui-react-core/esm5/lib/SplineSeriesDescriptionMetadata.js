...
var SplineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SplineSeriesDescriptionMetadata, _super);
    ...
    SplineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SplineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(SplineSeriesDescriptionMetadata.a);
    };
    ...
    SplineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("SplineSeries", function () { return new SplineSeriesDescription(); });
        a.t("SplineSeries", SplineSeriesDescriptionMetadata.a);
    };
