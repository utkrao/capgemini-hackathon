...
var FullStochasticOscillatorIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    FullStochasticOscillatorIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(FullStochasticOscillatorIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(FullStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
    ...
    FullStochasticOscillatorIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("FullStochasticOscillatorIndicator", function () { return new FullStochasticOscillatorIndicatorDescription(); });
        a.t("FullStochasticOscillatorIndicator", FullStochasticOscillatorIndicatorDescriptionMetadata.a);
    };
