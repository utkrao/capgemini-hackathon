...
var CalloutContentUpdatingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CalloutContentUpdatingEventArgsDescriptionMetadata, _super);
    ...
    CalloutContentUpdatingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(CalloutContentUpdatingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(CalloutContentUpdatingEventArgsDescriptionMetadata.a);
    };
    ...
    CalloutContentUpdatingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("CalloutContentUpdatingEventArgs", function () { return new CalloutContentUpdatingEventArgsDescription(); });
        a.t("CalloutContentUpdatingEventArgs", CalloutContentUpdatingEventArgsDescriptionMetadata.a);
    };
