...
var StepAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(StepAreaSeriesDescriptionMetadata, _super);
    ...
    StepAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(StepAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(StepAreaSeriesDescriptionMetadata.a);
    };
    ...
    StepAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("StepAreaSeries", function () { return new StepAreaSeriesDescription(); });
        a.t("StepAreaSeries", StepAreaSeriesDescriptionMetadata.a);
    };
