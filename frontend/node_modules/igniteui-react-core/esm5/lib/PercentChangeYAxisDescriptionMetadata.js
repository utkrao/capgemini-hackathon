...
var PercentChangeYAxisDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PercentChangeYAxisDescriptionMetadata, _super);
    ...
    PercentChangeYAxisDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PercentChangeYAxisDescriptionMetadata.a)) {
            return;
        }
        a.s(PercentChangeYAxisDescriptionMetadata.a);
    };
    ...
    PercentChangeYAxisDescriptionMetadata.d = function (a) {
        ...
        a.u("PercentChangeYAxis", function () { return new PercentChangeYAxisDescription(); });
        a.t("PercentChangeYAxis", PercentChangeYAxisDescriptionMetadata.a);
    };
