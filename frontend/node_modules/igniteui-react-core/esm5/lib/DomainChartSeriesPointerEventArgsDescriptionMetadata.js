...
var DomainChartSeriesPointerEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(DomainChartSeriesPointerEventArgsDescriptionMetadata, _super);
    ...
    DomainChartSeriesPointerEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DomainChartSeriesPointerEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(DomainChartSeriesPointerEventArgsDescriptionMetadata.a);
    ...
    DomainChartSeriesPointerEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("DomainChartSeriesPointerEventArgs", function () { return new DomainChartSeriesPointerEventArgsDescription(); });
        a.t("DomainChartSeriesPointerEventArgs", DomainChartSeriesPointerEventArgsDescriptionMetadata.a);
    };
