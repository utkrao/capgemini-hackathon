...
var RangeAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RangeAreaSeriesDescriptionMetadata, _super);
    ...
    RangeAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RangeAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(RangeAreaSeriesDescriptionMetadata.a);
    };
    ...
    RangeAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("RangeAreaSeries", function () { return new RangeAreaSeriesDescription(); });
        a.t("RangeAreaSeries", RangeAreaSeriesDescriptionMetadata.a);
    };
