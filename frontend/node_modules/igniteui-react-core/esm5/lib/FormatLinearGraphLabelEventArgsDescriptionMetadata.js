...
var FormatLinearGraphLabelEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(FormatLinearGraphLabelEventArgsDescriptionMetadata, _super);
    ...
    FormatLinearGraphLabelEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(FormatLinearGraphLabelEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(FormatLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
    ...
    FormatLinearGraphLabelEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("FormatLinearGraphLabelEventArgs", function () { return new FormatLinearGraphLabelEventArgsDescription(); });
        a.t("FormatLinearGraphLabelEventArgs", FormatLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
