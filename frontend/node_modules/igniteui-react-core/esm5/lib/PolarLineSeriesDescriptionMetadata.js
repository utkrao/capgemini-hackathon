...
var PolarLineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PolarLineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PolarLineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(PolarLineSeriesDescriptionMetadata.a);
    };
    ...
    PolarLineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("PolarLineSeries", function () { return new PolarLineSeriesDescription(); });
        a.t("PolarLineSeries", PolarLineSeriesDescriptionMetadata.a);
    };
