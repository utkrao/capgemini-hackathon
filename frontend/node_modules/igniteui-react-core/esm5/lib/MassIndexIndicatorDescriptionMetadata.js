...
var MassIndexIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(MassIndexIndicatorDescriptionMetadata, _super);
    ...
    MassIndexIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(MassIndexIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(MassIndexIndicatorDescriptionMetadata.a);
    };
    ...
    MassIndexIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("MassIndexIndicator", function () { return new MassIndexIndicatorDescription(); });
        a.t("MassIndexIndicator", MassIndexIndicatorDescriptionMetadata.a);
    };
