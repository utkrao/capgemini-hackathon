...
var ValueBrushScaleDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ValueBrushScaleDescriptionMetadata, _super);
    ...
    ValueBrushScaleDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ValueBrushScaleDescriptionMetadata.a)) {
            return;
        }
        a.s(ValueBrushScaleDescriptionMetadata.a);
    };
    ...
    ValueBrushScaleDescriptionMetadata.d = function (a) {
        ...
        a.u("ValueBrushScale", function () { return new ValueBrushScaleDescription(); });
        a.t("ValueBrushScale", ValueBrushScaleDescriptionMetadata.a);
    };
