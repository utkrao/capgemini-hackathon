...
var RenderRequestedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RenderRequestedEventArgsDescriptionMetadata, _super);
    ...
    RenderRequestedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RenderRequestedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(RenderRequestedEventArgsDescriptionMetadata.a);
    };
    ...
    RenderRequestedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("RenderRequestedEventArgs", function () { return new RenderRequestedEventArgsDescription(); });
        a.t("RenderRequestedEventArgs", RenderRequestedEventArgsDescriptionMetadata.a);
    };
