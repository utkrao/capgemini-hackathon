...
var AlignLinearGraphLabelEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(AlignLinearGraphLabelEventArgsDescriptionMetadata, _super);
    ...
    AlignLinearGraphLabelEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(AlignLinearGraphLabelEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(AlignLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
    ...
    AlignLinearGraphLabelEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("AlignLinearGraphLabelEventArgs", function () { return new AlignLinearGraphLabelEventArgsDescription(); });
        a.t("AlignLinearGraphLabelEventArgs", AlignLinearGraphLabelEventArgsDescriptionMetadata.a);
    };
