...
var DataSourceSchemaChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(DataSourceSchemaChangedEventArgsDescriptionMetadata, _super);
    ...
    DataSourceSchemaChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(DataSourceSchemaChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(DataSourceSchemaChangedEventArgsDescriptionMetadata.a);
    };
    ...
    DataSourceSchemaChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("DataSourceSchemaChangedEventArgs", function () { return new DataSourceSchemaChangedEventArgsDescription(); });
        a.t("DataSourceSchemaChangedEventArgs", DataSourceSchemaChangedEventArgsDescriptionMetadata.a);
    };
