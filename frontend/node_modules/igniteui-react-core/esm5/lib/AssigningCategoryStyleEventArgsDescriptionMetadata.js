...
var AssigningCategoryStyleEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(AssigningCategoryStyleEventArgsDescriptionMetadata, _super);
    ...
    AssigningCategoryStyleEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(AssigningCategoryStyleEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(AssigningCategoryStyleEventArgsDescriptionMetadata.a);
    };
    ...
    AssigningCategoryStyleEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("AssigningCategoryStyleEventArgs", function () { return new AssigningCategoryStyleEventArgsDescription(); });
        a.t("AssigningCategoryStyleEventArgs", AssigningCategoryStyleEventArgsDescriptionMetadata.a);
    };
