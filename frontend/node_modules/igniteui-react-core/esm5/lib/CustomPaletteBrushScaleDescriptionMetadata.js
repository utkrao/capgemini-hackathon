...
var CustomPaletteBrushScaleDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CustomPaletteBrushScaleDescriptionMetadata, _super);
    ...
    CustomPaletteBrushScaleDescriptionMetadata.b = function (a) {
        ...
        if (a.g(CustomPaletteBrushScaleDescriptionMetadata.a)) {
            return;
        }
        a.s(CustomPaletteBrushScaleDescriptionMetadata.a);
    };
    ...
    CustomPaletteBrushScaleDescriptionMetadata.d = function (a) {
        ...
        a.u("CustomPaletteBrushScale", function () { return new CustomPaletteBrushScaleDescription(); });
        a.t("CustomPaletteBrushScale", CustomPaletteBrushScaleDescriptionMetadata.a);
    };
