...
var AxisRangeChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisRangeChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(AxisRangeChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(AxisRangeChangedEventArgsDescriptionMetadata.a);
    };
    ...
    AxisRangeChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("AxisRangeChangedEventArgs", function () { return new AxisRangeChangedEventArgsDescription(); });
        a.t("AxisRangeChangedEventArgs", AxisRangeChangedEventArgsDescriptionMetadata.a);
    };
