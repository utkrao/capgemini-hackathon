...
var SelectedItemsChangingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SelectedItemsChangingEventArgsDescriptionMetadata, _super);
    ...
    SelectedItemsChangingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SelectedItemsChangingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(SelectedItemsChangingEventArgsDescriptionMetadata.a);
    };
    ...
    SelectedItemsChangingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("SelectedItemsChangingEventArgs", function () { return new SelectedItemsChangingEventArgsDescription(); });
        a.t("SelectedItemsChangingEventArgs", SelectedItemsChangingEventArgsDescriptionMetadata.a);
    };
