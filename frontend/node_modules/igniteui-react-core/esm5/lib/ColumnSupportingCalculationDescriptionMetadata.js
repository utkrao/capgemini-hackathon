...
var ColumnSupportingCalculationDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ColumnSupportingCalculationDescriptionMetadata, _super);
    ...
    ColumnSupportingCalculationDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ColumnSupportingCalculationDescriptionMetadata.a)) {
            return;
        }
        a.s(ColumnSupportingCalculationDescriptionMetadata.a);
    };
    ...
    ColumnSupportingCalculationDescriptionMetadata.d = function (a) {
        ...
        a.u("ColumnSupportingCalculation", function () { return new ColumnSupportingCalculationDescription(); });
        a.t("ColumnSupportingCalculation", ColumnSupportingCalculationDescriptionMetadata.a);
    };
