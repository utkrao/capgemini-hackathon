...
var ResponsiveStateEnteringEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ResponsiveStateEnteringEventArgsDescriptionMetadata, _super);
    ...
    ResponsiveStateEnteringEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ResponsiveStateEnteringEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(ResponsiveStateEnteringEventArgsDescriptionMetadata.a);
    };
    ...
    ResponsiveStateEnteringEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("ResponsiveStateEnteringEventArgs", function () { return new ResponsiveStateEnteringEventArgsDescription(); });
        a.t("ResponsiveStateEnteringEventArgs", ResponsiveStateEnteringEventArgsDescriptionMetadata.a);
    };
