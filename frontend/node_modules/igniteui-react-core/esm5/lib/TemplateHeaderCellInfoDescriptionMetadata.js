...
var TemplateHeaderCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TemplateHeaderCellInfoDescriptionMetadata, _super);
    ...
    TemplateHeaderCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TemplateHeaderCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.s(TemplateHeaderCellInfoDescriptionMetadata.a);
    };
    ...
    TemplateHeaderCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.u("TemplateHeaderCellInfo", function () { return new TemplateHeaderCellInfoDescription(); });
        a.t("TemplateHeaderCellInfo", TemplateHeaderCellInfoDescriptionMetadata.a);
    };
