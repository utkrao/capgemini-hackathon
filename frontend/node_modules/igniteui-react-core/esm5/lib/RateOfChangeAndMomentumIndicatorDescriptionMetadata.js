...
var RateOfChangeAndMomentumIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RateOfChangeAndMomentumIndicatorDescriptionMetadata, _super);
    ...
    RateOfChangeAndMomentumIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RateOfChangeAndMomentumIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(RateOfChangeAndMomentumIndicatorDescriptionMetadata.a);
    };
    ...
    RateOfChangeAndMomentumIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("RateOfChangeAndMomentumIndicator", function () { return new RateOfChangeAndMomentumIndicatorDescription(); });
        a.t("RateOfChangeAndMomentumIndicator", RateOfChangeAndMomentumIndicatorDescriptionMetadata.a);
    };
