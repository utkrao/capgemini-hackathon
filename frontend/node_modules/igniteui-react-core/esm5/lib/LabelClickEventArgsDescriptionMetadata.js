...
var LabelClickEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(LabelClickEventArgsDescriptionMetadata, _super);
    ...
    LabelClickEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(LabelClickEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(LabelClickEventArgsDescriptionMetadata.a);
    };
    ...
    LabelClickEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("LabelClickEventArgs", function () { return new LabelClickEventArgsDescription(); });
        a.t("LabelClickEventArgs", LabelClickEventArgsDescriptionMetadata.a);
    };
