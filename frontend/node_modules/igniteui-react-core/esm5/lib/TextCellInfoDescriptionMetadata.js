...
var TextCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TextCellInfoDescriptionMetadata, _super);
    ...
    TextCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TextCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.s(TextCellInfoDescriptionMetadata.a);
    };
    ...
    TextCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.u("TextCellInfo", function () { return new TextCellInfoDescription(); });
        a.t("TextCellInfo", TextCellInfoDescriptionMetadata.a);
    };
