...
var RangeColumnSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RangeColumnSeriesDescriptionMetadata, _super);
    ...
    RangeColumnSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RangeColumnSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(RangeColumnSeriesDescriptionMetadata.a);
    };
    ...
    RangeColumnSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("RangeColumnSeries", function () { return new RangeColumnSeriesDescription(); });
        a.t("RangeColumnSeries", RangeColumnSeriesDescriptionMetadata.a);
    };
