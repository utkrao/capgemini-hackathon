...
var GridColumnAnimationSettingsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(GridColumnAnimationSettingsDescriptionMetadata, _super);
    ...
    GridColumnAnimationSettingsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridColumnAnimationSettingsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridColumnAnimationSettingsDescriptionMetadata.a);
    };
    ...
    GridColumnAnimationSettingsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridColumnAnimationSettings", function () { return new GridColumnAnimationSettingsDescription(); });
        a.t("GridColumnAnimationSettings", GridColumnAnimationSettingsDescriptionMetadata.a);
    };
