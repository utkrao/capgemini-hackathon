...
var ScaleLegendDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ScaleLegendDescriptionMetadata, _super);
    ...
    ScaleLegendDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ScaleLegendDescriptionMetadata.a)) {
            return;
        }
        a.s(ScaleLegendDescriptionMetadata.a);
    };
    ...
    ScaleLegendDescriptionMetadata.d = function (a) {
        ...
        a.u("ScaleLegend", function () { return new ScaleLegendDescription(); });
        a.t("ScaleLegend", ScaleLegendDescriptionMetadata.a);
    };
