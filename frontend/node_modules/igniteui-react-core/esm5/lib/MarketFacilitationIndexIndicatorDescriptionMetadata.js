...
var MarketFacilitationIndexIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(MarketFacilitationIndexIndicatorDescriptionMetadata, _super);
    ...
    MarketFacilitationIndexIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(MarketFacilitationIndexIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(MarketFacilitationIndexIndicatorDescriptionMetadata.a);
    };
    ...
    MarketFacilitationIndexIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("MarketFacilitationIndexIndicator", function () { return new MarketFacilitationIndexIndicatorDescription(); });
        a.t("MarketFacilitationIndexIndicator", MarketFacilitationIndexIndicatorDescriptionMetadata.a);
    };
