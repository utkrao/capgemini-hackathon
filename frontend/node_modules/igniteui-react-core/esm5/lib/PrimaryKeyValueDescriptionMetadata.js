...
var PrimaryKeyValueDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PrimaryKeyValueDescriptionMetadata, _super);
    ...
    PrimaryKeyValueDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PrimaryKeyValueDescriptionMetadata.a)) {
            return;
        }
        a.s(PrimaryKeyValueDescriptionMetadata.a);
    };
    ...
    PrimaryKeyValueDescriptionMetadata.d = function (a) {
        ...
        a.u("PrimaryKeyValue", function () { return new PrimaryKeyValueDescription(); });
        a.t("PrimaryKeyValue", PrimaryKeyValueDescriptionMetadata.a);
    };
