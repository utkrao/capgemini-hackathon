...
var TileGeneratorMapImageryDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TileGeneratorMapImageryDescriptionMetadata, _super);
    ...
    TileGeneratorMapImageryDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TileGeneratorMapImageryDescriptionMetadata.a)) {
            return;
        }
        a.s(TileGeneratorMapImageryDescriptionMetadata.a);
    };
    ...
    TileGeneratorMapImageryDescriptionMetadata.d = function (a) {
        ...
        a.u("TileGeneratorMapImagery", function () { return new TileGeneratorMapImageryDescription(); });
        a.t("TileGeneratorMapImagery", TileGeneratorMapImageryDescriptionMetadata.a);
    };
