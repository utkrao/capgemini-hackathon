...
var SelectedItemChangingEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SelectedItemChangingEventArgsDescriptionMetadata, _super);
    ...
    SelectedItemChangingEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SelectedItemChangingEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(SelectedItemChangingEventArgsDescriptionMetadata.a);
    };
    ...
    SelectedItemChangingEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("SelectedItemChangingEventArgs", function () { return new SelectedItemChangingEventArgsDescription(); });
        a.t("SelectedItemChangingEventArgs", SelectedItemChangingEventArgsDescriptionMetadata.a);
    };
