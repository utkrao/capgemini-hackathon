...
var SelectedItemsChangedEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SelectedItemsChangedEventArgsDescriptionMetadata, _super);
    ...
    SelectedItemsChangedEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SelectedItemsChangedEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(SelectedItemsChangedEventArgsDescriptionMetadata.a);
    };
    ...
    SelectedItemsChangedEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("SelectedItemsChangedEventArgs", function () { return new SelectedItemsChangedEventArgsDescription(); });
        a.t("SelectedItemsChangedEventArgs", SelectedItemsChangedEventArgsDescriptionMetadata.a);
    };
