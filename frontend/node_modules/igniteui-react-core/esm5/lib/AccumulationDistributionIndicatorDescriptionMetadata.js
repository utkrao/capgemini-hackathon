...
var AccumulationDistributionIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(AccumulationDistributionIndicatorDescriptionMetadata, _super);
    ...
    AccumulationDistributionIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(AccumulationDistributionIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(AccumulationDistributionIndicatorDescriptionMetadata.a);
    };
    ...
    AccumulationDistributionIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("AccumulationDistributionIndicator", function () { return new AccumulationDistributionIndicatorDescription(); });
        a.t("AccumulationDistributionIndicator", AccumulationDistributionIndicatorDescriptionMetadata.a);
    };
