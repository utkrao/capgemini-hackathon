...
var SectionHeaderCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SectionHeaderCellInfoDescriptionMetadata, _super);
    ...
    SectionHeaderCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SectionHeaderCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.s(SectionHeaderCellInfoDescriptionMetadata.a);
    };
    ...
    SectionHeaderCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.u("SectionHeaderCellInfo", function () { return new SectionHeaderCellInfoDescription(); });
        a.t("SectionHeaderCellInfo", SectionHeaderCellInfoDescriptionMetadata.a);
    };
