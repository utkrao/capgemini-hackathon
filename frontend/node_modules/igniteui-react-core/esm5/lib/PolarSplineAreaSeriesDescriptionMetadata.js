...
var PolarSplineAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PolarSplineAreaSeriesDescriptionMetadata, _super);
    ...
    PolarSplineAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PolarSplineAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(PolarSplineAreaSeriesDescriptionMetadata.a);
    };
    ...
    PolarSplineAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("PolarSplineAreaSeries", function () { return new PolarSplineAreaSeriesDescription(); });
        a.t("PolarSplineAreaSeries", PolarSplineAreaSeriesDescriptionMetadata.a);
    };
