...
var CustomContourValueResolverEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(CustomContourValueResolverEventArgsDescriptionMetadata, _super);
    ...
    CustomContourValueResolverEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(CustomContourValueResolverEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(CustomContourValueResolverEventArgsDescriptionMetadata.a);
    };
    ...
    CustomContourValueResolverEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("CustomContourValueResolverEventArgs", function () { return new CustomContourValueResolverEventArgsDescription(); });
        a.t("CustomContourValueResolverEventArgs", CustomContourValueResolverEventArgsDescriptionMetadata.a);
    };
