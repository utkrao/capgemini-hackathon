...
var TemplateCellInfoDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TemplateCellInfoDescriptionMetadata, _super);
    ...
    TemplateCellInfoDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TemplateCellInfoDescriptionMetadata.a)) {
            return;
        }
        a.s(TemplateCellInfoDescriptionMetadata.a);
    };
    ...
    TemplateCellInfoDescriptionMetadata.d = function (a) {
        ...
        a.u("TemplateCellInfo", function () { return new TemplateCellInfoDescription(); });
        a.t("TemplateCellInfo", TemplateCellInfoDescriptionMetadata.a);
    };
