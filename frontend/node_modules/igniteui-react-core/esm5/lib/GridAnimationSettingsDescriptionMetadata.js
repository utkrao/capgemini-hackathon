...
var GridAnimationSettingsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(GridAnimationSettingsDescriptionMetadata, _super);
    ...
    GridAnimationSettingsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridAnimationSettingsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridAnimationSettingsDescriptionMetadata.a);
    };
    ...
    GridAnimationSettingsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridAnimationSettings", function () { return new GridAnimationSettingsDescription(); });
        a.t("GridAnimationSettings", GridAnimationSettingsDescriptionMetadata.a);
    };
