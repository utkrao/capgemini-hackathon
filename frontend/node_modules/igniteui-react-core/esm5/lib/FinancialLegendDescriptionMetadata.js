...
var FinancialLegendDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(FinancialLegendDescriptionMetadata, _super);
    ...
    FinancialLegendDescriptionMetadata.b = function (a) {
        ...
        if (a.g(FinancialLegendDescriptionMetadata.a)) {
            return;
        }
        a.s(FinancialLegendDescriptionMetadata.a);
    };
    ...
    FinancialLegendDescriptionMetadata.d = function (a) {
        ...
        a.u("FinancialLegend", function () { return new FinancialLegendDescription(); });
        a.t("FinancialLegend", FinancialLegendDescriptionMetadata.a);
    };
