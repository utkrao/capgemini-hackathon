...
var SplineAreaSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(SplineAreaSeriesDescriptionMetadata, _super);
    ...
    SplineAreaSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(SplineAreaSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(SplineAreaSeriesDescriptionMetadata.a);
    };
    ...
    SplineAreaSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("SplineAreaSeries", function () { return new SplineAreaSeriesDescription(); });
        a.t("SplineAreaSeries", SplineAreaSeriesDescriptionMetadata.a);
    };
