...
var NegativeVolumeIndexIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(NegativeVolumeIndexIndicatorDescriptionMetadata, _super);
    ...
    NegativeVolumeIndexIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(NegativeVolumeIndexIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(NegativeVolumeIndexIndicatorDescriptionMetadata.a);
    };
    ...
    NegativeVolumeIndexIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("NegativeVolumeIndexIndicator", function () { return new NegativeVolumeIndexIndicatorDescription(); });
        a.t("NegativeVolumeIndexIndicator", NegativeVolumeIndexIndicatorDescriptionMetadata.a);
    };
