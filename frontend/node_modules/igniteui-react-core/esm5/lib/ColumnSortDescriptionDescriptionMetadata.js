...
var ColumnSortDescriptionDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ColumnSortDescriptionDescriptionMetadata, _super);
    ...
    ColumnSortDescriptionDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ColumnSortDescriptionDescriptionMetadata.a)) {
            return;
        }
        a.s(ColumnSortDescriptionDescriptionMetadata.a);
    };
    ...
    ColumnSortDescriptionDescriptionMetadata.d = function (a) {
        ...
        a.u("ColumnSortDescription", function () { return new ColumnSortDescriptionDescription(); });
        a.t("ColumnSortDescription", ColumnSortDescriptionDescriptionMetadata.a);
    };
