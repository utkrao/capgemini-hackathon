...
var PolarScatterSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PolarScatterSeriesDescriptionMetadata, _super);
    ...
    PolarScatterSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PolarScatterSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(PolarScatterSeriesDescriptionMetadata.a);
    };
    ...
    PolarScatterSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("PolarScatterSeries", function () { return new PolarScatterSeriesDescription(); });
        a.t("PolarScatterSeries", PolarScatterSeriesDescriptionMetadata.a);
    };
