...
var LinearContourValueResolverDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LinearContourValueResolverDescriptionMetadata.b = function (a) {
        ...
        if (a.g(LinearContourValueResolverDescriptionMetadata.a)) {
            return;
        }
        a.s(LinearContourValueResolverDescriptionMetadata.a);
    };
    ...
    LinearContourValueResolverDescriptionMetadata.d = function (a) {
        ...
        a.u("LinearContourValueResolver", function () { return new LinearContourValueResolverDescription(); });
        a.t("LinearContourValueResolver", LinearContourValueResolverDescriptionMetadata.a);
    };
