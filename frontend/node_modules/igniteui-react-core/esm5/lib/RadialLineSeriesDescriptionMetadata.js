...
var RadialLineSeriesDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RadialLineSeriesDescriptionMetadata, _super);
    ...
    RadialLineSeriesDescriptionMetadata.b = function (a) {
        ...
        if (a.g(RadialLineSeriesDescriptionMetadata.a)) {
            return;
        }
        a.s(RadialLineSeriesDescriptionMetadata.a);
    };
    ...
    RadialLineSeriesDescriptionMetadata.d = function (a) {
        ...
        a.u("RadialLineSeries", function () { return new RadialLineSeriesDescription(); });
        a.t("RadialLineSeries", RadialLineSeriesDescriptionMetadata.a);
    };
