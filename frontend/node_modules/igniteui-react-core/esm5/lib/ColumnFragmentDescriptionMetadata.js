...
var ColumnFragmentDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ColumnFragmentDescriptionMetadata, _super);
    ...
    ColumnFragmentDescriptionMetadata.b = function (a) {
        ...
        if (a.g(ColumnFragmentDescriptionMetadata.a)) {
            return;
        }
        a.s(ColumnFragmentDescriptionMetadata.a);
    };
    ...
    ColumnFragmentDescriptionMetadata.d = function (a) {
        ...
        a.u("ColumnFragment", function () { return new ColumnFragmentDescription(); });
        a.t("ColumnFragment", ColumnFragmentDescriptionMetadata.a);
    };
