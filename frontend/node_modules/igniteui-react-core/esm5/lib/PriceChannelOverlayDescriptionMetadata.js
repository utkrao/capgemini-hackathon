...
var PriceChannelOverlayDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(PriceChannelOverlayDescriptionMetadata, _super);
    ...
    PriceChannelOverlayDescriptionMetadata.b = function (a) {
        ...
        if (a.g(PriceChannelOverlayDescriptionMetadata.a)) {
            return;
        }
        a.s(PriceChannelOverlayDescriptionMetadata.a);
    };
    ...
    PriceChannelOverlayDescriptionMetadata.d = function (a) {
        ...
        a.u("PriceChannelOverlay", function () { return new PriceChannelOverlayDescription(); });
        a.t("PriceChannelOverlay", PriceChannelOverlayDescriptionMetadata.a);
    };
