...
var StandardDeviationIndicatorDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(StandardDeviationIndicatorDescriptionMetadata, _super);
    ...
    StandardDeviationIndicatorDescriptionMetadata.b = function (a) {
        ...
        if (a.g(StandardDeviationIndicatorDescriptionMetadata.a)) {
            return;
        }
        a.s(StandardDeviationIndicatorDescriptionMetadata.a);
    };
    ...
    StandardDeviationIndicatorDescriptionMetadata.d = function (a) {
        ...
        a.u("StandardDeviationIndicator", function () { return new StandardDeviationIndicatorDescription(); });
        a.t("StandardDeviationIndicator", StandardDeviationIndicatorDescriptionMetadata.a);
    };
