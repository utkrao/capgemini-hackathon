...
var GridFilterDialogFilterChangeEventArgsDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    GridFilterDialogFilterChangeEventArgsDescriptionMetadata.b = function (a) {
        ...
        if (a.g(GridFilterDialogFilterChangeEventArgsDescriptionMetadata.a)) {
            return;
        }
        a.s(GridFilterDialogFilterChangeEventArgsDescriptionMetadata.a);
    ...
    GridFilterDialogFilterChangeEventArgsDescriptionMetadata.d = function (a) {
        ...
        a.u("GridFilterDialogFilterChangeEventArgs", function () { return new GridFilterDialogFilterChangeEventArgsDescription(); });
        a.t("GridFilterDialogFilterChangeEventArgs", GridFilterDialogFilterChangeEventArgsDescriptionMetadata.a);
    };
