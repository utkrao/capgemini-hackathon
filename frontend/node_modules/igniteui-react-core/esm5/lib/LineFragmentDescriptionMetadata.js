...
var LineFragmentDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    LineFragmentDescriptionMetadata.b = function (a) {
        ...
        if (a.g(LineFragmentDescriptionMetadata.a)) {
            return;
        }
        a.s(LineFragmentDescriptionMetadata.a);
    };
    ...
    LineFragmentDescriptionMetadata.d = function (a) {
        ...
        a.u("LineFragment", function () { return new LineFragmentDescription(); });
        a.t("LineFragment", LineFragmentDescriptionMetadata.a);
    };
