...
var TextHeaderDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TextHeaderDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TextHeaderDescriptionMetadata.a)) {
            return;
        }
        a.s(TextHeaderDescriptionMetadata.a);
    };
    ...
    TextHeaderDescriptionMetadata.d = function (a) {
        ...
        a.u("TextHeader", function () { return new TextHeaderDescription(); });
        a.t("TextHeader", TextHeaderDescriptionMetadata.a);
    };
