...
var TemplateHeaderDescriptionMetadata = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TemplateHeaderDescriptionMetadata, _super);
    ...
    TemplateHeaderDescriptionMetadata.b = function (a) {
        ...
        if (a.g(TemplateHeaderDescriptionMetadata.a)) {
            return;
        }
        a.s(TemplateHeaderDescriptionMetadata.a);
    ...
    TemplateHeaderDescriptionMetadata.d = function (a) {
        ...
        a.u("TemplateHeader", function () { return new TemplateHeaderDescription(); });
        a.t("TemplateHeader", TemplateHeaderDescriptionMetadata.a);
    };
