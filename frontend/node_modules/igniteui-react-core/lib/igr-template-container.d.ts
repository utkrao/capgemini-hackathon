...
export declare class IgrTemplateContainer extends React.Component<IIgrTemplateContainerProps> {
    ...
    private _template;
    set template(value: React.SFC<any> | React.ComponentClass<any>);
    get template(): React.SFC<any> | React.ComponentClass<any>;
    private _containerTemplate;
    set containerTemplate(value: React.SFC<any> | React.ComponentClass<any>);
    get containerTemplate(): React.SFC<any> | React.ComponentClass<any>;
