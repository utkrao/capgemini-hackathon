 ...
 * @hidden
 */
export let WebFloatPaneActionDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebFloatPaneActionDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(WebFloatPaneActionDescriptionMetadata.a)) {
                return;
            }
            a.s(WebFloatPaneActionDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("WebFloatPaneAction", () => new WebFloatPaneActionDescription());
            a.t("WebFloatPaneAction", WebFloatPaneActionDescriptionMetadata.a);
        }
    }
    WebFloatPaneActionDescriptionMetadata.$t = /*@__PURE__*/ markType(WebFloatPaneActionDescriptionMetadata, 'WebFloatPaneActionDescriptionMetadata');
