...
export let WebRangeSliderDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebRangeSliderDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(WebRangeSliderDescriptionMetadata.a)) {
                return;
            }
            a.s(WebRangeSliderDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("WebRangeSlider", () => new WebRangeSliderDescription());
            a.t("WebRangeSlider", WebRangeSliderDescriptionMetadata.a);
        }
    }
