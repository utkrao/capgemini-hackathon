 ...
 * @hidden
 */
export let ListPanelItemModelDescriptionMetadata = /*@__PURE__*/ (() => {
    class ListPanelItemModelDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(ListPanelItemModelDescriptionMetadata.a)) {
                return;
            }
            a.s(ListPanelItemModelDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("ListPanelItemModel", () => new ListPanelItemModelDescription());
            a.t("ListPanelItemModel", ListPanelItemModelDescriptionMetadata.a);
        }
    }
    ListPanelItemModelDescriptionMetadata.$t = /*@__PURE__*/ markType(ListPanelItemModelDescriptionMetadata, 'ListPanelItemModelDescriptionMetadata');
