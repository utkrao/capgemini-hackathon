...
export let AlignRadialGaugeLabelEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class AlignRadialGaugeLabelEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(AlignRadialGaugeLabelEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.s(AlignRadialGaugeLabelEventArgsDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("AlignRadialGaugeLabelEventArgs", () => new AlignRadialGaugeLabelEventArgsDescription());
            a.t("AlignRadialGaugeLabelEventArgs", AlignRadialGaugeLabelEventArgsDescriptionMetadata.a);
        }
    }
