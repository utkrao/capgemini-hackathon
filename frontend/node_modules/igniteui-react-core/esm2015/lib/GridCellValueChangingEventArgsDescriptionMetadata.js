...
export let GridCellValueChangingEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class GridCellValueChangingEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(GridCellValueChangingEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.s(GridCellValueChangingEventArgsDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("GridCellValueChangingEventArgs", () => new GridCellValueChangingEventArgsDescription());
            a.t("GridCellValueChangingEventArgs", GridCellValueChangingEventArgsDescriptionMetadata.a);
        }
    }
