 ...
 * @hidden
 */
export let YearToDateExpressionDescriptionMetadata = /*@__PURE__*/ (() => {
    class YearToDateExpressionDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(YearToDateExpressionDescriptionMetadata.a)) {
                return;
            }
            a.s(YearToDateExpressionDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("YearToDateExpression", () => new YearToDateExpressionDescription());
            a.t("YearToDateExpression", YearToDateExpressionDescriptionMetadata.a);
        }
    }
    YearToDateExpressionDescriptionMetadata.$t = /*@__PURE__*/ markType(YearToDateExpressionDescriptionMetadata, 'YearToDateExpressionDescriptionMetadata');
