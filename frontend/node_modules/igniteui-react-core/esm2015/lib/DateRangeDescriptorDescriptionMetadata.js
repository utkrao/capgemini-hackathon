 ...
 * @hidden
 */
export let DateRangeDescriptorDescriptionMetadata = /*@__PURE__*/ (() => {
    class DateRangeDescriptorDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(DateRangeDescriptorDescriptionMetadata.a)) {
                return;
            }
            a.s(DateRangeDescriptorDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("DateRangeDescriptor", () => new DateRangeDescriptorDescription());
            a.t("DateRangeDescriptor", DateRangeDescriptorDescriptionMetadata.a);
        }
    }
    DateRangeDescriptorDescriptionMetadata.$t = /*@__PURE__*/ markType(DateRangeDescriptorDescriptionMetadata, 'DateRangeDescriptorDescriptionMetadata');
