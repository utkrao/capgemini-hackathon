 ...
 * @hidden
 */
export let PropertyEditorPanelDescriptionMetadata = /*@__PURE__*/ (() => {
    class PropertyEditorPanelDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(PropertyEditorPanelDescriptionMetadata.a)) {
                return;
            }
            a.s(PropertyEditorPanelDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("PropertyEditorPanel", () => new PropertyEditorPanelDescription());
            a.t("PropertyEditorPanel", PropertyEditorPanelDescriptionMetadata.a);
        }
        static e(a) {
    ...
    PropertyEditorPanelDescriptionMetadata.$t = /*@__PURE__*/ markType(PropertyEditorPanelDescriptionMetadata, 'PropertyEditorPanelDescriptionMetadata');
