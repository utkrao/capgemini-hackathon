 ...
 * @hidden
 */
export let WebComponentBoolValueChangedEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebComponentBoolValueChangedEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(WebComponentBoolValueChangedEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.s(WebComponentBoolValueChangedEventArgsDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("WebComponentBoolValueChangedEventArgs", () => new WebComponentBoolValueChangedEventArgsDescription());
            a.t("WebComponentBoolValueChangedEventArgs", WebComponentBoolValueChangedEventArgsDescriptionMetadata.a);
        }
    }
    WebComponentBoolValueChangedEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebComponentBoolValueChangedEventArgsDescriptionMetadata, 'WebComponentBoolValueChangedEventArgsDescriptionMetadata');
