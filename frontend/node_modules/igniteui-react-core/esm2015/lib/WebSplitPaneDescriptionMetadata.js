...
export let WebSplitPaneDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebSplitPaneDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(WebSplitPaneDescriptionMetadata.a)) {
                return;
            }
            a.s(WebSplitPaneDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("WebSplitPane", () => new WebSplitPaneDescription());
            a.t("WebSplitPane", WebSplitPaneDescriptionMetadata.a);
        }
    }
    WebSplitPaneDescriptionMetadata.$t = /*@__PURE__*/ markType(WebSplitPaneDescriptionMetadata, 'WebSplitPaneDescriptionMetadata');
