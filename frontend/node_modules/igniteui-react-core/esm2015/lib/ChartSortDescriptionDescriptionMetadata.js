 ...
 * @hidden
 */
export let ChartSortDescriptionDescriptionMetadata = /*@__PURE__*/ (() => {
    class ChartSortDescriptionDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(ChartSortDescriptionDescriptionMetadata.a)) {
                return;
            }
            a.s(ChartSortDescriptionDescriptionMetadata.a);
        }
        static c(a) {
            a.item("Field", "String");
        ...
        static d(a) {
            ...
            a.u("ChartSortDescription", () => new ChartSortDescriptionDescription());
            a.t("ChartSortDescription", ChartSortDescriptionDescriptionMetadata.a);
        }
    }
    ChartSortDescriptionDescriptionMetadata.$t = /*@__PURE__*/ markType(ChartSortDescriptionDescriptionMetadata, 'ChartSortDescriptionDescriptionMetadata');
