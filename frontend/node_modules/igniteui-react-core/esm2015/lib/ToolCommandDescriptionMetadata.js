...
export let ToolCommandDescriptionMetadata = /*@__PURE__*/ (() => {
    class ToolCommandDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(ToolCommandDescriptionMetadata.a)) {
                return;
            }
            a.s(ToolCommandDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("ToolCommand", () => new ToolCommandDescription());
            a.t("ToolCommand", ToolCommandDescriptionMetadata.a);
        }
    }
