 ...
 * @hidden
 */
export let DataLegendStylingRowEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class DataLegendStylingRowEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(DataLegendStylingRowEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.s(DataLegendStylingRowEventArgsDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("DataLegendStylingRowEventArgs", () => new DataLegendStylingRowEventArgsDescription());
            a.t("DataLegendStylingRowEventArgs", DataLegendStylingRowEventArgsDescriptionMetadata.a);
        }
    }
    DataLegendStylingRowEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(DataLegendStylingRowEventArgsDescriptionMetadata, 'DataLegendStylingRowEventArgsDescriptionMetadata');
