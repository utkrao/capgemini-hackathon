...
export let SizeScaleDescriptionMetadata = /*@__PURE__*/ (() => {
    class SizeScaleDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(SizeScaleDescriptionMetadata.a)) {
                return;
            }
            a.s(SizeScaleDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("SizeScale", () => new SizeScaleDescription());
            a.t("SizeScale", SizeScaleDescriptionMetadata.a);
        }
    }
