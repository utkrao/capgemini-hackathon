 ...
 * @hidden
 */
export let WrapperExpressionDescriptionMetadata = /*@__PURE__*/ (() => {
    class WrapperExpressionDescriptionMetadata extends Base {
        static b(a) {
    ...
    WrapperExpressionDescriptionMetadata.$t = /*@__PURE__*/ markType(WrapperExpressionDescriptionMetadata, 'WrapperExpressionDescriptionMetadata');
