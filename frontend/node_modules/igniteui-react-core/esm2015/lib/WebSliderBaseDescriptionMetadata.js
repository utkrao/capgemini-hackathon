...
export let WebSliderBaseDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebSliderBaseDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(WebSliderBaseDescriptionMetadata.a)) {
                return;
            }
            a.s(WebSliderBaseDescriptionMetadata.a);
        }
        static c(a) {
        ...
        static d(a) {
            ...
            a.u("WebSliderBase", () => new WebSliderBaseDescription());
            a.t("WebSliderBase", WebSliderBaseDescriptionMetadata.a);
        }
    }
