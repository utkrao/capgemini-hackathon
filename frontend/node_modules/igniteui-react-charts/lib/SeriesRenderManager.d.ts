...
export declare class SeriesRenderManager extends Base {
    ...
    protected u(a: Series, b: HighlightingInfo, c: number, d: number, e: number, f: boolean): void;
    protected v(a: Series, b: HighlightingInfo, c: number, d: number, e: number): void;
    ab(a: number): void;
    z(a: Series, b: HighlightingInfo, c: boolean, d: boolean, e: boolean): void;
    aa(a: number): void;
    y(a: Series, b: HighlightingInfo, c: boolean, d: boolean, e: number, f: number): void;
}
