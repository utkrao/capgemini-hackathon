...
var IgrShapeSeriesBase = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(IgrShapeSeriesBase.prototype, "actualItemSearchMode", {
        ...
        set: function (v) {
            this.i.qt = ensureEnum(ShapeItemSearchMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(IgrShapeSeriesBase.prototype, "itemSearchMode", {
        ...
        */
        ...
        set: function (v) {
            this.i.qv = ensureEnum(ShapeItemSearchMode_$type, v);
        },
        enumerable: false,
        configurable: true
    });
        ...
        */
        get: function () {
            ...
            if (!this.i.qp.externalObject) {
                var e = IgrNumericXAxis._createFromInternal(this.i.qp);
                if (e) {
    ...
    Object.defineProperty(IgrShapeSeriesBase.prototype, "yAxis", {
        ...
        */
        get: function () {
            ...
            if (!this.i.qr.externalObject) {
                var e = IgrNumericYAxis._createFromInternal(this.i.qr);
                if (e) {
                    e._implementation = this.i.qr;
                }
                this.i.qr.externalObject = e;
            }
            return this.i.qr.externalObject;
        },
        set: function (v) {
            if (v != null && this._stylingContainer && v._styling)
                v._styling(this._stylingContainer, this, this);
