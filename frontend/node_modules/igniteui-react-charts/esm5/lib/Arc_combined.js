...
var Arc = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Arc.prototype.a2 = function () {
        return new ArcView(this);
    };
    Arc.prototype.gl = function (a) {
        _super.prototype.gl.call(this, a);
        this.jc = a;
    };
    Object.defineProperty(Arc.prototype, "je", {
        get: function () {
            return this.jd;
        },
        set: function (a) {
            var b = this.jd;
            this.jd = a;
            this.jc.b8(b, this.jd);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(Arc.prototype, "jh", {
        get: function () {
            if (this.je != null) {
                return this.je.i;
            }
    ...
    Arc.prototype.gh = function (a, b) {
        _super.prototype.gh.call(this, a, b);
        if (this.je != null) {
            this.je.c.ax.bu(a, b);
        }
    };
    Arc.prototype.fw = function (a, b) {
        if (this.je != null && this.je.d != null) {
            _super.prototype.fw.call(this, a, b);
            var c = this.jf(a);
            if (c != null) {
                this.je.d.bj(c, b);
            }
    ...
    Arc.prototype.gz = function (a, b) {
        if (this.je != null && this.je.d != null) {
            _super.prototype.gz.call(this, a, b);
            var c = this.jf(a);
            if (c != null) {
                this.je.d.b5(c, b);
            }
    ...
    Arc.prototype.jf = function (a) {
        var e_1, _a;
        try {
            for (var _b = __values(fromEnum(this.jb.g)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                if (b.b == a) {
                    return b;
                }
    ...
    Arc.prototype.go = function () {
        ...
        for (var e = 0; e < a; e++) {
            ...
            if (this.iz == 1) {
                d += PieChartBase.df(Math.abs(g) * this.ji / this.dh);
            }
            else {
                d -= PieChartBase.df(Math.abs(g) * this.ji / this.dh);
            }
    ...
    Arc.prototype.gv = function () {
        ...
        if (this.bp == null || this.bp.count == 0 || ((this.je != null && this.je.c != null) && (this.je.d != null && !this.je.d.series.contains(this.je.c)))) {
            a.clearLegendItemsForSeries(this.je.c);
            return;
        }
        ...
        var _loop_1 = function (b) {
            ...
            var d = this_1.dm(b);
            var e = b.b0;
            var f = b.isOthersSlice ? this_1.e3 : (this_1.bq != null && this_1.bq.count > 0) ? this_1.bq.item(this_1.cm._inner[b.a5]) : null;
            f = (f == null && this_1.bp.count > 0) ? this_1.bp.item(this_1.cm._inner[b.a5]) : f;
            c.content = ((function () {
                var $ret = new PieSliceDataContext();
                $ret.series = _this.je.c;
                $ret.slice = b;
                $ret.item = b.dataContext;
                $ret.itemBrush = e;
                $ret.legendLabel = f != null ? f.toString() : null;
                $ret.itemLabel = d != null ? d.toString() : null;
                $ret.percentValue = _this.c7(b);
        ...
        if (a.isItemwise) {
            var k = a;
            k.createLegendItemsInsert(this.cj, this.je.c);
        }
    };
    Arc.prototype.gp = function (a, b, c, d) {
        _super.prototype.gp.call(this, a, b, c, d);
        switch (b) {
            case Arc.$$p[0]:
                this.jg = d;
                this.go();
            ...
            case "Legend":
                ...
                if (e != null && this.je != null && this.je.c != null) {
                    e.clearLegendItemsForSeries(this.je.c);
                }
                break;
        }
    };
    Arc.prototype.jj = function () {
        return this.a3.ad();
    };
    Arc.$t = markType(Arc, 'Arc', PieChartBase.$);
    Arc.$$p = markDep(DependencyProperty, PropertyMetadata, Arc, 'gr', ['EndAngle:ji:jl', [1, 360]]);
    return Arc;
}(PieChartBase));
export { Arc };
/**
...
var ArcItem = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ArcItem.prototype.o = function (a, b) {
        ...
        var o = e.count;
        var p = f.count > 0;
        var q = PieChartBase.df(a);
        var r = PieChartBase.df(a);
        if (p) {
            o++;
        }
        var _loop_2 = function (s) {
            ...
            var v = 1;
            if (v == 1) {
                r += PieChartBase.df(Math.abs(u) * b / c);
            }
            else {
                r -= PieChartBase.df(Math.abs(u) * b / c);
            }
    ...
    RingControl.prototype.an = function () {
        ...
        try {
            for (var _b = __values(fromEnum(this.ao)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if ((d.width != this.ai.q.width || d.height != this.ai.q.height) && d.a3.s()) {
            ...
            switch (_d.label) {
                ...
                case 1:
                    if (!!_b.done)
                        return [3 /*break*/, 4];
                    b = _b.value;
                    if (!PieChartBase.ci(a, b.itemsSource))
                        return [3 /*break*/, 3];
                    return [4 /*yield*/, b];
                case 2:
                    _d.sent();
...
var RingControlView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RingControlView.prototype.a = function () {
        ...
        a.cd = true;
        a.de = this.b.al.a9;
        a.b6 = this.b.al.ax.av;
        a.b7 = this.b.al.ax.aw;
        a.a5 = this.b.al.ar;
        a.ew = this.b.al.b3;
        a.c0 = this.b.al.ax.a1;
        return a;
    };
    ...
    RingControlView.prototype.ab = function (a) {
        this.k(a, a.jj().rootWrapper);
        a.f8(a.width, a.height);
    };
        ...
        switch (b.propertyName) {
            case "LabelExtent":
                for (var c = 0; c < this.f.count; c++) {
                    this.f._inner[c].c9 = b.newValue;
                }
                break;
            case "LabelMemberPath":
                for (var d = 0; d < this.f.count; d++) {
                    this.f._inner[d].eh = b.newValue;
                }
                break;
            case "LabelsPosition":
            ...
            case "LabelTemplate":
                for (var f = 0; f < this.f.count; f++) {
                    this.f._inner[f].g9 = b.newValue;
                }
                break;
            case "ValueMemberPath":
                for (var g = 0; g < this.f.count; g++) {
                    this.f._inner[g].fs = b.newValue;
                }
                break;
            case "ToolTip":
                for (var h = 0; h < this.f.count; h++) {
                    this.f._inner[h].dp = b.newValue;
                }
                break;
            case "LeaderLineVisibility":
                for (var i = 0; i < this.f.count; i++) {
                    this.f._inner[i].ja = EnumUtil.getEnumValue(Visibility_$type, b.newValue);
                }
                break;
            case "LeaderLineStyle":
                for (var j = 0; j < this.f.count; j++) {
                    this.f._inner[j].i6 = b.newValue;
                }
                break;
            case "LeaderLineType":
            ...
            case "SelectedStyle":
                for (var v = 0; v < this.f.count; v++) {
                    this.f._inner[v].i8 = b.newValue;
                }
                break;
            case "SelectedStyleResolved":
                for (var w = 0; w < this.f.count; w++) {
                    this.f._inner[w].i8 = b.newValue;
                }
                break;
            case "RadiusFactor":
                for (var x = 0; x < this.f.count; x++) {
                    this.f._inner[x].de = b.newValue;
                }
                break;
        }
    };
