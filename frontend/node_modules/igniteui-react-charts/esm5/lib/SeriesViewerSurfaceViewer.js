...
var SeriesViewerSurfaceViewer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Object.defineProperty(SeriesViewerSurfaceViewer.prototype, "maximumZoomLevel", {
        get: function () {
            if (this.l.gg == 0.0001 && this.l.gf == 0.0001) {
                return 0.9;
            }
            else {
                return 1 - Math.max(this.l.gg, this.l.gf);
            }
        },
        enumerable: false,
        configurable: true
    ...
    SeriesViewerSurfaceViewer.prototype.v = function (a, b, c) {
        ...
        switch (a) {
            case SeriesViewerSurfaceViewer.$$p[0]:
                ...
                var d = this.l != null && this.l.cn != null && this.l.cn.updatingSliderRanges;
                if (!this.o && !d) {
                    var e = 1 - this.zoomLevel;
                    var f = RectUtil.l(this.l.s9);
                    var g = new Rect(0, f.x - e / 2, f.y - e / 2, e, e);
                    this.l.tp = SeriesViewerSurfaceViewer.z(this.l.tp, g, this.l.er(), this.l.es(), this.worldRect);
                }
                this.w();
                if (this.l.cn != null) {
                    this.l.cn.pushZoomLevel(this.zoomLevel);
                }
                break;
        }
    };
