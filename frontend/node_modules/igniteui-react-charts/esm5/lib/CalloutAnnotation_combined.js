...
var CalloutAnnotation = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CalloutAnnotation.prototype.a1 = function (a, b, c) {
        switch (a) {
    ...
    Object.defineProperty(CalloutAnnotation.prototype, "backgroundPadding", {
        get: function () {
            if (this.n) {
                this.n = false;
                this.br = new Thickness(1, this.v, this.x, this.w, this.u);
            }
            return this.br;
        },
        set: function (a) {
