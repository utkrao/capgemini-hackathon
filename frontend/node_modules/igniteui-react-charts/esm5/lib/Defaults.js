...
var Defaults = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Defaults.ae = BrushUtil.g(255, 187, 187, 187);
    Defaults.j = DeviceUtils.g(1);
    Defaults.ag = BrushUtil.g(255, 255, 255, 255);
    Defaults.af = BrushUtil.g(255, 0, 0, 0);
    ...
    Defaults.ah = BrushUtil.g(255, 238, 88, 121);
    Defaults.ai = BrushUtil.g(255, 238, 88, 121);
    ...
    Defaults.c = 1;
    Defaults.e = 2;
    Defaults.aq = ColorUtil.r("#000000");
    Defaults.ap = ColorUtil.r("#ee5879");
    Defaults.al = BrushUtil.g(255, 0, 0, 0);
    Defaults.ak = BrushUtil.g(255, 238, 88, 121);
    Defaults.q = DeviceUtils.g(4);
    Defaults.x = DeviceUtils.g(5);
    Defaults.aa = DeviceUtils.g(2);
    Defaults.am = BrushUtil.g(255, 0, 0, 0);
    Defaults.z = DeviceUtils.g(2);
    Defaults.y = DeviceUtils.g(2);
    Defaults.f = 1;
    Defaults.b = 1;
    Defaults.aj = BrushUtil.g(255, 0, 0, 0);
    ...
    Defaults.ao = BrushUtil.g(255, 170, 211, 223);
    Defaults.an = BrushUtil.g(255, 255, 255, 255);
    return Defaults;
}(Base));
export { Defaults };
