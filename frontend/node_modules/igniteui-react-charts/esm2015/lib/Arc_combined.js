...
export let Arc = /*@__PURE__*/ (() => {
    class Arc extends PieChartBase {
        ...
        jf(a) {
            for (let b of fromEnum(this.jb.g)) {
                if (b.b == a) {
                    return b;
                }
            }
        ...
        gv() {
            ...
            for (let b of fromEnum(this.bv.a)) {
                let c = new ContentControl();
                let d = this.dm(b);
                let e = b.b0;
                let f = b.isOthersSlice ? this.e3 : (this.bq != null && this.bq.count > 0) ? this.bq.item(this.cm._inner[b.a5]) : null;
                f = (f == null && this.bp.count > 0) ? this.bp.item(this.cm._inner[b.a5]) : f;
                c.content = ((() => {
                    let $ret = new PieSliceDataContext();
                    $ret.series = this.je.c;
                    $ret.slice = b;
                    $ret.item = b.dataContext;
                    $ret.itemBrush = e;
                    $ret.legendLabel = f != null ? f.toString() : null;
                    $ret.itemLabel = d != null ? d.toString() : null;
                    $ret.percentValue = this.c7(b);
    ...
    Arc.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, Arc, 'gr', ['EndAngle:ji:jl', [1, 360]]);
    return Arc;
})();
/**
 * @hidden
...
export let ArcItem = /*@__PURE__*/ (() => {
    class ArcItem extends Base {
        ...
        o(a, b) {
            ...
            let o = e.count;
            let p = f.count > 0;
            let q = PieChartBase.df(a);
            let r = PieChartBase.df(a);
            if (p) {
                o++;
            }
            for (let s = 0; s < o; s++) {
