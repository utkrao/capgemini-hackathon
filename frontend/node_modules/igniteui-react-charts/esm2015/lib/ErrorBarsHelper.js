...
export let ErrorBarsHelper = /*@__PURE__*/ (() => {
    class ErrorBarsHelper extends Base {
        ...
        k(a, b, c, d, e) {
            ...
            let j = new ScalerParams(0, f, g, c.cg, h);
            let k = c.ei(a, j);
            let l = b.getIndependentValue();
            d = Math.abs(Math.round(c.ei(a + l, j) - k));
            e = Math.abs(Math.round(c.ei(a - l, j) - k));
            return {
                p3: d,
                p4: e
            };
        ...
        j(a, b, c, d, e) {
            ...
            g = h.p0;
            f = h.p1;
            let i = new ScalerParams(1, f, g, c.cg);
            let j = c.el(a, i);
            let k = b.getIndependentValue();
            d = Math.abs(Math.round(c.ei(j + k, i) - a));
            e = Math.abs(Math.round(c.ei(j - k, i) - a));
            return {
                p3: d,
                p4: e
            };
        ...
        f(a, b, c, d, e, f) {
            ...
            h = i.p0;
            g = i.p1;
            let j = new ScalerParams(1, g, h, c.cg);
            let k = new ScalerParams(1, g, h, d.cg);
            let l = c.el(a, j);
            let m = b.getDependentValue(l);
            e = Math.abs(Math.round(c.ei(l + m, k) - a));
            f = Math.abs(Math.round(c.ei(l - m, k) - a));
            return {
                p4: e,
                p5: f
            };
        ...
        h(a, b, c, d, e) {
            ...
            let i = new ScalerParams(1, f, g, c.cg);
            let j = c.el(a, i);
            d = Math.abs(Math.round(c.ei(j + b, i) - a));
            e = Math.abs(Math.round(c.ei(j - b, i) - a));
            return {
                p3: d,
                p4: e
            };
        ...
        l(a, b, c, d) {
            ...
            if (a.getCalculatorType() == 3) {
                ...
                f = i.p1;
                h = this.a.getEffectiveViewport();
                let j = new ScalerParams(0, f, g, b.cg, h);
                e.x = Math.round(b.ei(d, j));
                e.y = Math.round(c.y);
            }
            else {
                e.x = Math.round(c.x);
