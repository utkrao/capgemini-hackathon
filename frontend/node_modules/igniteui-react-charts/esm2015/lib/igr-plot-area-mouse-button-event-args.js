...
*/
export class IgrPlotAreaMouseButtonEventArgs {
    constructor() {
    }
    /**
     * @hidden
    ...
    get manipulationOccurred() {
        return this.i.manipulationOccurred;
    }
    set manipulationOccurred(v) {
        this.i.manipulationOccurred = ensureBool(v);
    }
    /**
     * Gets the Chart associated with the current event.
    */
    get viewer() {
        if (this.i.viewer == null) {
            return null;
        }
        return this.i.viewer.externalObject;
    }
    set viewer(v) {
